...
namespace uml4net.Tools.Tests.Commands
{
    ...
    public class HtmlReportCommandTestFixture
    {
        ...
        public async Task Verify_that_InvokeAsync_returns_0_for_UML_xmi()
        {
            ...
            this.htmlReportGenerator.Verify(x => x.GenerateReport(It.IsAny<FileInfo>(), It.IsAny<DirectoryInfo>(), It.IsAny<bool>(), It.IsAny<Dictionary<string,string>>(), It.IsAny<FileInfo>()), Times.Once);
