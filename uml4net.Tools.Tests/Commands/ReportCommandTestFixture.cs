...
namespace uml4net.Tools.Tests.Commands
{
    ...
    public class ReportCommandTestFixture
    {
        ...
        public async Task Verify_that_InvokeAsync_returns_0()
        {
            ...
            this.reportGenerator.Verify(x => x.GenerateReport(It.IsAny<FileInfo>(), It.IsAny<DirectoryInfo>(), It.IsAny<bool>(), It.IsAny<Dictionary<string, string>>(),It.IsAny<FileInfo>()), Times.Once);
