...
namespace uml4net.xmi.Readers
{
    ...
    public class DestroyLinkActionReader : XmiElementReader<IDestroyLinkAction>, IXmiElementReader<IDestroyLinkAction>
    {
        ...
        /// </param>
        public DestroyLinkActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndDestructionData)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:LinkEndDestructionData");
