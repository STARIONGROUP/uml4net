...
namespace uml4net.xmi.Readers
{
    ...
    public class DestroyLinkActionReader : XmiElementReader<IDestroyLinkAction>, IXmiElementReader<IDestroyLinkAction>
    {
        ...
        /// </returns>
        public override IDestroyLinkAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndDestructionData)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:LinkEndDestructionData");
