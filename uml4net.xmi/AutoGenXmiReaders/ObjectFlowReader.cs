...
namespace uml4net.xmi.Readers
{
    ...
    public class ObjectFlowReader : XmiElementReader<IObjectFlow>, IXmiElementReader<IObjectFlow>
    {
        ...
        /// </param>
        public ObjectFlowReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "guard":
                                var guardValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory);
                            ...
                            case "visibility":
                                ...
                                break;
                            case "weight":
                                var weightValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory);
