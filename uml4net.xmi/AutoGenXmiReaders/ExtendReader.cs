...
namespace uml4net.xmi.Readers.UseCases
{
    ...
    public class ExtendReader : XmiElementReader<IExtend>, IXmiElementReader<IExtend>
    {
        ...
        /// </param>
        public ExtendReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IExtend Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var extensionLocation = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "extensionLocation":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, extensionLocation, "extensionLocation");
                                break;
                            case "name":
                ...
                if (extensionLocation.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("extensionLocation", extensionLocation);
                }
