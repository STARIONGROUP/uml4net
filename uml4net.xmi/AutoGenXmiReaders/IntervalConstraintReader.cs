...
namespace uml4net.xmi.Readers.Values
{
    ...
    public class IntervalConstraintReader : XmiElementReader<IIntervalConstraint>, IXmiElementReader<IIntervalConstraint>
    {
        ...
        /// </param>
        public IntervalConstraintReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "constrainedElement":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, constrainedElement, "constrainedElement");
                                break;
                            case "context":
                            ...
                            case "owningTemplateParameter":
                                ...
                                break;
                            case "specification":
                                var specification = (IInterval)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Interval");
