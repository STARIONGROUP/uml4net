...
namespace uml4net.xmi.Readers
{
    ...
    public class IntervalConstraintReader : XmiElementReader<IIntervalConstraint>, IXmiElementReader<IIntervalConstraint>
    {
        ...
        /// </param>
        public IntervalConstraintReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "owningTemplateParameter":
                                ...
                                break;
                            case "specification":
                                var specificationValue = (IInterval)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Interval");
