...
namespace uml4net.xmi.Readers
{
    ...
    public class LinkEndCreationDataReader : XmiElementReader<ILinkEndCreationData>, IXmiElementReader<ILinkEndCreationData>
    {
        ...
        /// </param>
        public LinkEndCreationDataReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
