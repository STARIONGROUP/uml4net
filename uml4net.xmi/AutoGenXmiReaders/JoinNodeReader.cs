...
namespace uml4net.xmi.Readers
{
    ...
    public class JoinNodeReader : XmiElementReader<IJoinNode>, IXmiElementReader<IJoinNode>
    {
        ...
        /// </returns>
        public override IJoinNode Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isLeaf":
                                ...
                                break;
                            case "joinSpec":
                                var joinSpecValue = (IValueSpecification)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
