...
namespace uml4net.xmi.Readers
{
    ...
    public class JoinNodeReader : XmiElementReader<IJoinNode>, IXmiElementReader<IJoinNode>
    {
        ...
        /// </param>
        public JoinNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
