...
namespace uml4net.xmi.Readers.Interactions
{
    ...
    public class ContinuationReader : XmiElementReader<IContinuation>, IXmiElementReader<IContinuation>
    {
        ...
        /// </param>
        public ContinuationReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComment":
                                ...
                                break;
                            case "setting":
                                var settingXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(settingXmlElement))
                                {
                                    poco.Setting = bool.Parse(settingXmlElement);
                                }
                                break;
                            case "visibility":
