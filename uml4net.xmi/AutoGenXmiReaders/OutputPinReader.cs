...
namespace uml4net.xmi.Readers
{
    ...
    public class OutputPinReader : XmiElementReader<IOutputPin>, IXmiElementReader<IOutputPin>
    {
        ...
        /// </param>
        public OutputPinReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
