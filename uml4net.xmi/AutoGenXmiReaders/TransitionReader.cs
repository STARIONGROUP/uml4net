...
namespace uml4net.xmi.Readers
{
    ...
    public class TransitionReader : XmiElementReader<ITransition>, IXmiElementReader<ITransition>
    {
        ...
        /// </param>
        public TransitionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ITransition Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "container":
                                ...
                                break;
                            case "effect":
                                var effectValue = (IBehavior)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
