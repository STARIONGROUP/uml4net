...
namespace uml4net.xmi.Readers
{
    ...
    public class TransitionReader : XmiElementReader<ITransition>, IXmiElementReader<ITransition>
    {
        ...
        /// </param>
        public TransitionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
