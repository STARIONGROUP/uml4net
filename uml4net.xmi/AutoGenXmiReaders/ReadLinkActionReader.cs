...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadLinkActionReader : XmiElementReader<IReadLinkAction>, IXmiElementReader<IReadLinkAction>
    {
        ...
        /// </param>
        public ReadLinkActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndData)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:LinkEndData");
