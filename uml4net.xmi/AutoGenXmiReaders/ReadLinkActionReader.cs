...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadLinkActionReader : XmiElementReader<IReadLinkAction>, IXmiElementReader<IReadLinkAction>
    {
        ...
        /// </returns>
        public override IReadLinkAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndData)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:LinkEndData");
