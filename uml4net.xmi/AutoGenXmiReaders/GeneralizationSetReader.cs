...
namespace uml4net.xmi.Readers
{
    ...
    public class GeneralizationSetReader : XmiElementReader<IGeneralizationSet>, IXmiElementReader<IGeneralizationSet>
    {
        ...
        /// </param>
        public GeneralizationSetReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
