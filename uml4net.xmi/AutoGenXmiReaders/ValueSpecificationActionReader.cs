...
namespace uml4net.xmi.Readers
{
    ...
    public class ValueSpecificationActionReader : XmiElementReader<IValueSpecificationAction>, IXmiElementReader<IValueSpecificationAction>
    {
        ...
        /// </param>
        public ValueSpecificationActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ValueSpecificationActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
