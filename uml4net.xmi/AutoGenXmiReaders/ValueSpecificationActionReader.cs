...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class ValueSpecificationActionReader : XmiElementReader<IValueSpecificationAction>, IXmiElementReader<IValueSpecificationAction>
    {
        ...
        /// </param>
        public ValueSpecificationActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "result":
                                ...
                                break;
                            case "value":
                                var value = (IValueSpecification)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
