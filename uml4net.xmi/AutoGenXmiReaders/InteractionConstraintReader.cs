...
namespace uml4net.xmi.Readers
{
    ...
    public class InteractionConstraintReader : XmiElementReader<IInteractionConstraint>, IXmiElementReader<IInteractionConstraint>
    {
        ...
        /// </param>
        public InteractionConstraintReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "context":
                                ...
                                break;
                            case "maxint":
                                var maxintValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory);
                                poco.Maxint.Add(maxintValue);
                                break;
                            case "minint":
                                var minintValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory);
