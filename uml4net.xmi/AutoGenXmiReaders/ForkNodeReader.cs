...
namespace uml4net.xmi.Readers
{
    ...
    public class ForkNodeReader : XmiElementReader<IForkNode>, IXmiElementReader<IForkNode>
    {
        ...
        /// </param>
        public ForkNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
