...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadLinkObjectEndActionReader : XmiElementReader<IReadLinkObjectEndAction>, IXmiElementReader<IReadLinkObjectEndAction>
    {
        ...
        /// </param>
        public ReadLinkObjectEndActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadLinkObjectEndActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
