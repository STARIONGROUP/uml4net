...
namespace uml4net.xmi.Readers
{
    ...
    public class ConsiderIgnoreFragmentReader : XmiElementReader<IConsiderIgnoreFragment>, IXmiElementReader<IConsiderIgnoreFragment>
    {
        ...
        /// </param>
        public ConsiderIgnoreFragmentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "cfragmentGate":
                                var cfragmentGateValue = (IGate)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Gate");
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "operand":
                                var operandValue = (IInteractionOperand)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InteractionOperand");
