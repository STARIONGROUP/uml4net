...
namespace uml4net.xmi.Readers
{
    ...
    public class ConsiderIgnoreFragmentReader : XmiElementReader<IConsiderIgnoreFragment>, IXmiElementReader<IConsiderIgnoreFragment>
    {
        ...
        /// </returns>
        public override IConsiderIgnoreFragment Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "cfragmentGate":
                                var cfragmentGateValue = (IGate)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Gate");
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "operand":
                                var operandValue = (IInteractionOperand)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InteractionOperand");
