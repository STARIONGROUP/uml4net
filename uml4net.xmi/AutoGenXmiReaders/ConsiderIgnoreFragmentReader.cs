...
namespace uml4net.xmi.Readers
{
    ...
    public class ConsiderIgnoreFragmentReader : XmiElementReader<IConsiderIgnoreFragment>, IXmiElementReader<IConsiderIgnoreFragment>
    {
        ...
        /// </param>
        public ConsiderIgnoreFragmentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
        ...
        public override IConsiderIgnoreFragment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    this.logger.LogCritical("Failed to add element type [{Poco}] with id [{Id}] as it was already in the Cache. The XMI document seems to have duplicate xmi:id values", "ConsiderIgnoreFragment", poco.XmiId);
                }
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            case (KnowNamespacePrefixes.Uml, "cfragmentGate"):
                                var cfragmentGateValue = (IGate)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:Gate");
                            ...
                            case (KnowNamespacePrefixes.Uml, "operand"):
                                var operandValue = (IInteractionOperand)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:InteractionOperand");
