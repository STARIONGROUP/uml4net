...
namespace uml4net.xmi.Readers
{
    ...
    public class ClearVariableActionReader : XmiElementReader<IClearVariableAction>, IXmiElementReader<IClearVariableAction>
    {
        ...
        /// </param>
        public ClearVariableActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ClearVariableActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
