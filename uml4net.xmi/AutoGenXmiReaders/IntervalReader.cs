...
namespace uml4net.xmi.Readers
{
    ...
    public class IntervalReader : XmiElementReader<IInterval>, IXmiElementReader<IInterval>
    {
        ...
        /// </param>
        public IntervalReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
