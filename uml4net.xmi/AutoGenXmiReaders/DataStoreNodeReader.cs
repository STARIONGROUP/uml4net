...
namespace uml4net.xmi.Readers
{
    ...
    public class DataStoreNodeReader : XmiElementReader<IDataStoreNode>, IXmiElementReader<IDataStoreNode>
    {
        ...
        /// </param>
        public DataStoreNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
