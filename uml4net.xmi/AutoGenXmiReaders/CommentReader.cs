...
namespace uml4net.xmi.Readers
{
    ...
    public class CommentReader : XmiElementReader<IComment>, IXmiElementReader<IComment>
    {
        ...
        /// </param>
        public CommentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            default:
                                ...
                                {
                                    this.Logger.LogWarning($"Not Supported: CommentReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                                }
                                break;
                        }
                    }
