...
namespace uml4net.xmi.Readers
{
    ...
    public class ClassReader : XmiElementReader<IClass>, IXmiElementReader<IClass>
    {
        ...
        /// </param>
        public ClassReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
