...
namespace uml4net.xmi.Readers.Values
{
    ...
    public class DurationObservationReader : XmiElementReader<IDurationObservation>, IXmiElementReader<IDurationObservation>
    {
        ...
        /// </param>
        public DurationObservationReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IDurationObservation Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "event":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, eventValues, "event");
                                break;
                            case "firstEvent":
                ...
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("event", eventValues);
                }
