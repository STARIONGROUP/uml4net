...
namespace uml4net.xmi.Readers
{
    ...
    public class StereotypeReader : XmiElementReader<IStereotype>, IXmiElementReader<IStereotype>
    {
        ...
        /// </returns>
        public override IStereotype Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "generalization":
                                ...
                                break;
                            case "icon":
                                var iconValue = (IImage)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Image");
