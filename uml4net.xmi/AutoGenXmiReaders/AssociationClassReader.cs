...
namespace uml4net.xmi.Readers
{
    ...
    public class AssociationClassReader : XmiElementReader<IAssociationClass>, IXmiElementReader<IAssociationClass>
    {
        ...
        /// </param>
        public AssociationClassReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedConnector":
                                ...
                                break;
                            case "ownedEnd":
                                var ownedEndValue = (IProperty)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Property");
