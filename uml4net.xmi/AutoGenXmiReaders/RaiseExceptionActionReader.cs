...
namespace uml4net.xmi.Readers
{
    ...
    public class RaiseExceptionActionReader : XmiElementReader<IRaiseExceptionAction>, IXmiElementReader<IRaiseExceptionAction>
    {
        ...
        /// </returns>
        public override IRaiseExceptionAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "exception":
                                var exceptionValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
