...
namespace uml4net.xmi.Readers
{
    ...
    public class ComponentReader : XmiElementReader<IComponent>, IXmiElementReader<IComponent>
    {
        ...
        /// </returns>
        public override IComponent Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "powertypeExtent":
                                ...
                                break;
                            case "realization":
                                var realizationValue = (IComponentRealization)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:ComponentRealization");
