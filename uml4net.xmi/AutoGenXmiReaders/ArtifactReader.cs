...
namespace uml4net.xmi.Readers
{
    ...
    public class ArtifactReader : XmiElementReader<IArtifact>, IXmiElementReader<IArtifact>
    {
        ...
        /// </param>
        public ArtifactReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            case (KnowNamespacePrefixes.Uml, "manifestation"):
                                var manifestationValue = (IManifestation)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:Manifestation");
                            ...
                            case (KnowNamespacePrefixes.Uml, "nestedArtifact"):
                                var nestedArtifactValue = (IArtifact)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:Artifact");
