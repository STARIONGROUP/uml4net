...
namespace uml4net.xmi.Readers.Deployments
{
    ...
    public class ArtifactReader : XmiElementReader<IArtifact>, IXmiElementReader<IArtifact>
    {
        ...
        /// </param>
        public ArtifactReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IArtifact Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isLeaf":
                                ...
                                break;
                            case "manifestation":
                                var manifestation = (IManifestation)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Manifestation");
                                poco.Manifestation.Add(manifestation);
                                break;
                            case "name":
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "nestedArtifact":
                                var nestedArtifact = (IArtifact)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Artifact");
                                poco.NestedArtifact.Add(nestedArtifact);
                                break;
                            case "ownedAttribute":
