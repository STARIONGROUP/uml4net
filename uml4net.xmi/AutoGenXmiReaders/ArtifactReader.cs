...
namespace uml4net.xmi.Readers
{
    ...
    public class ArtifactReader : XmiElementReader<IArtifact>, IXmiElementReader<IArtifact>
    {
        ...
        /// </param>
        public ArtifactReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isLeaf":
                                ...
                                break;
                            case "manifestation":
                                var manifestationValue = (IManifestation)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:Manifestation");
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "nestedArtifact":
                                var nestedArtifactValue = (IArtifact)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:Artifact");
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ArtifactReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
