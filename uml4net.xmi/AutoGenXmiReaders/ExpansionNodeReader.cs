...
namespace uml4net.xmi.Readers
{
    ...
    public class ExpansionNodeReader : XmiElementReader<IExpansionNode>, IXmiElementReader<IExpansionNode>
    {
        ...
        /// </param>
        public ExpansionNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IExpansionNode Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
