...
namespace uml4net.xmi.Readers
{
    ...
    public class ExpansionNodeReader : XmiElementReader<IExpansionNode>, IXmiElementReader<IExpansionNode>
    {
        ...
        /// </param>
        public ExpansionNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
