...
namespace uml4net.xmi.Readers
{
    ...
    public class PortReader : XmiElementReader<IPort>, IXmiElementReader<IPort>
    {
        ...
        /// </param>
        public PortReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "datatype":
                                ...
                                break;
                            case "defaultValue":
                                var defaultValueValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory);
                            ...
                            case "isBehavior":
                                ...
                                if (!string.IsNullOrEmpty(isBehaviorValue))
                                {
                            ...
                            case "isConjugated":
                                ...
                                if (!string.IsNullOrEmpty(isConjugatedValue))
                                {
                            ...
                            case "isService":
                                ...
                                if (!string.IsNullOrEmpty(isServiceValue))
                                {
                            ...
                            case "protocol":
                                ...
                                break;
                            case "qualifier":
                                var qualifierValue = (IProperty)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Property");
                            ...
                            default:
                                ...
                                {
                                    this.Logger.LogWarning("Not Supported: PortReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
