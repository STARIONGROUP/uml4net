...
namespace uml4net.xmi.Readers
{
    ...
    public class PortReader : XmiElementReader<IPort>, IXmiElementReader<IPort>
    {
        ...
        /// </param>
        public PortReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
