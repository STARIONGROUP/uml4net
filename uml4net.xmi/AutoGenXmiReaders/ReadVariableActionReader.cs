...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadVariableActionReader : XmiElementReader<IReadVariableAction>, IXmiElementReader<IReadVariableAction>
    {
        ...
        /// </param>
        public ReadVariableActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
