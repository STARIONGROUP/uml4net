...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadVariableActionReader : XmiElementReader<IReadVariableAction>, IXmiElementReader<IReadVariableAction>
    {
        ...
        /// </param>
        public ReadVariableActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadVariableActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
