...
namespace uml4net.xmi.Readers
{
    ...
    public class RealizationReader : XmiElementReader<IRealization>, IXmiElementReader<IRealization>
    {
        ...
        /// </param>
        public RealizationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
