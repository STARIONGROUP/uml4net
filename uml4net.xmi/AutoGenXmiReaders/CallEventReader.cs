...
namespace uml4net.xmi.Readers
{
    ...
    public class CallEventReader : XmiElementReader<ICallEvent>, IXmiElementReader<ICallEvent>
    {
        ...
        /// </param>
        public CallEventReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
