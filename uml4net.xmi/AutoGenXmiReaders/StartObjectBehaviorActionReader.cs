...
namespace uml4net.xmi.Readers
{
    ...
    public class StartObjectBehaviorActionReader : XmiElementReader<IStartObjectBehaviorAction>, IXmiElementReader<IStartObjectBehaviorAction>
    {
        ...
        /// </param>
        public StartObjectBehaviorActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "argument":
                                var argumentValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
