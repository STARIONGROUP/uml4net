...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class StartObjectBehaviorActionReader : XmiElementReader<IStartObjectBehaviorAction>, IXmiElementReader<IStartObjectBehaviorAction>
    {
        ...
        /// </param>
        public StartObjectBehaviorActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IStartObjectBehaviorAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
