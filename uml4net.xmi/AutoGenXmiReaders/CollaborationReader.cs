...
namespace uml4net.xmi.Readers.StructuredClassifiers
{
    ...
    public class CollaborationReader : XmiElementReader<ICollaboration>, IXmiElementReader<ICollaboration>
    {
        ...
        /// </param>
        public CollaborationReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        public override ICollaboration Read(XmlReader xmlReader)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var collaborationRole = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "collaborationRole":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, collaborationRole, "collaborationRole");
                                break;
                ...
                if (collaborationRole.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("collaborationRole", collaborationRole);
                }
