...
namespace uml4net.xmi.Readers
{
    ...
    public class CollaborationReader : XmiElementReader<ICollaboration>, IXmiElementReader<ICollaboration>
    {
        ...
        /// </param>
        public CollaborationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        public override ICollaboration Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var collaborationRoleXmlAttribute = xmlReader.GetAttribute("collaborationRole");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"CollaborationReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
