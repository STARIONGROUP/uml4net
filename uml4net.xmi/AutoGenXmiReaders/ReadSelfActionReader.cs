...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadSelfActionReader : XmiElementReader<IReadSelfAction>, IXmiElementReader<IReadSelfAction>
    {
        ...
        /// </param>
        public ReadSelfActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadSelfActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
