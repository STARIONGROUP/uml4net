...
namespace uml4net.xmi.Readers
{
    ...
    public class CentralBufferNodeReader : XmiElementReader<ICentralBufferNode>, IXmiElementReader<ICentralBufferNode>
    {
        ...
        /// </param>
        public CentralBufferNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
