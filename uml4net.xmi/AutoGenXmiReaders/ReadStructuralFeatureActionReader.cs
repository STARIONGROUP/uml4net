...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadStructuralFeatureActionReader : XmiElementReader<IReadStructuralFeatureAction>, IXmiElementReader<IReadStructuralFeatureAction>
    {
        ...
        /// </param>
        public ReadStructuralFeatureActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadStructuralFeatureActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
