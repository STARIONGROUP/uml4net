...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadExtentActionReader : XmiElementReader<IReadExtentAction>, IXmiElementReader<IReadExtentAction>
    {
        ...
        /// </param>
        public ReadExtentActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadExtentActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
