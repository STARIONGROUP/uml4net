...
namespace uml4net.xmi.Readers
{
    ...
    public class ConnectionPointReferenceReader : XmiElementReader<IConnectionPointReference>, IXmiElementReader<IConnectionPointReference>
    {
        ...
        /// </param>
        public ConnectionPointReferenceReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
