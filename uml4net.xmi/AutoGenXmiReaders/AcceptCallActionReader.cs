...
namespace uml4net.xmi.Readers
{
    ...
    public class AcceptCallActionReader : XmiElementReader<IAcceptCallAction>, IXmiElementReader<IAcceptCallAction>
    {
        ...
        /// </param>
        public AcceptCallActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IAcceptCallAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var isUnmarshallXmlAttribute = xmlReader.GetAttribute("isUnmarshall");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "returnInformation":
                                var returnInformationValue = (IOutputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:OutputPin");
                                poco.ReturnInformation.Add(returnInformationValue);
                                break;
                            case "trigger":
                                var triggerValue = (ITrigger)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Trigger");
