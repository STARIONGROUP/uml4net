...
namespace uml4net.xmi.Readers
{
    ...
    public class AcceptCallActionReader : XmiElementReader<IAcceptCallAction>, IXmiElementReader<IAcceptCallAction>
    {
        ...
        /// </returns>
        public override IAcceptCallAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "returnInformation":
                                var returnInformationValue = (IOutputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:OutputPin");
                                poco.ReturnInformation.Add(returnInformationValue);
                                break;
                            case "trigger":
                                var triggerValue = (ITrigger)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Trigger");
