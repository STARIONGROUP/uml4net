                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isLocallyReentrant":
                                ...
                                break;
                            case "isUnmarshall":
                                var isUnmarshallXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(isUnmarshallXmlElement))
                                {
                                    poco.IsUnmarshall = bool.Parse(isUnmarshallXmlElement);
                                }
                                break;
                            ...
                            case "returnInformation":
                                var returnInformation = (IOutputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:OutputPin");
