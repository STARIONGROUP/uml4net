...
namespace uml4net.xmi.Readers
{
    ...
    public class UseCaseReader : XmiElementReader<IUseCase>, IXmiElementReader<IUseCase>
    {
        ...
        /// </param>
        public UseCaseReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "elementImport":
                                ...
                                break;
                            case "extend":
                                var extendValue = (IExtend)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Extend");
                                poco.Extend.Add(extendValue);
                                break;
                            case "extensionPoint":
                                var extensionPointValue = (IExtensionPoint)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:ExtensionPoint");
                            ...
                            case "generalization":
                                ...
                                break;
                            case "include":
                                var includeValue = (IInclude)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Include");
                            ...
                            default:
                                ...
                                {
                                    this.Logger.LogWarning("Not Supported: UseCaseReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
