...
namespace uml4net.xmi.Readers
{
    ...
    public class SignalEventReader : XmiElementReader<ISignalEvent>, IXmiElementReader<ISignalEvent>
    {
        ...
        /// </param>
        public SignalEventReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
