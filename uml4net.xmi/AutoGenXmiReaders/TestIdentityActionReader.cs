...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class TestIdentityActionReader : XmiElementReader<ITestIdentityAction>, IXmiElementReader<ITestIdentityAction>
    {
        ...
        /// </param>
        public TestIdentityActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "first":
                                var first = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.First.Add(first);
                                break;
                            case "handler":
                            ...
                            case "result":
                                ...
                                break;
                            case "second":
                                var second = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.Second.Add(second);
                                break;
                            case "visibility":
