...
namespace uml4net.xmi.Readers
{
    ...
    public class ReclassifyObjectActionReader : XmiElementReader<IReclassifyObjectAction>, IXmiElementReader<IReclassifyObjectAction>
    {
        ...
        /// </param>
        public ReclassifyObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IExtenderReaderRegistry extenderReaderRegistry, ILoggerFactory loggerFactory)
        ...
        public override IReclassifyObjectAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                if (!this.Cache.TryAdd(poco))
                {
                    ...
                    this.logger.LogError("The xmi:id is not unique within the document, the element that was read first is kept: ReclassifyObjectAction [{XmiId}] property [xmi:id] at line:position {LineNumber}:{LinePosition}", poco.XmiId, xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                }
                ...
                {
                    poco.IsReplaceAll = XmlConvert.ToBoolean(isReplaceAllXmlAttribute);
                }
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            case (KnowNamespacePrefixes.Uml, "isReplaceAll"):
                                ...
                                {
                                    poco.IsReplaceAll = XmlConvert.ToBoolean(isReplaceAllValue);
                                }
                            ...
                            case (KnowNamespacePrefixes.Uml, "localPrecondition"):
                                if (!TryCollectCompositeReferencePropertyIdentifier(xmlReader, poco, "localPrecondition", poco.LocalPrecondition.Count))
                                {
                            ...
                            case (KnowNamespacePrefixes.Uml, "newClassifier"):
                                TryCollectMultiValueReferencePropertyIdentifiers(xmlReader, poco, "newClassifier");
                                break;
                            ...
                            case (KnowNamespacePrefixes.Uml, "oldClassifier"):
                                TryCollectMultiValueReferencePropertyIdentifiers(xmlReader, poco, "oldClassifier");
                                break;
                            ...
                            case (KnowNamespacePrefixes.Uml, "redefinitionContext"):
                                ...
                                this.logger.LogDebug("Ignoring the serialized derived property {LocalName} of ReclassifyObjectAction at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, xmlLineInfo.LineNumber, xmlLineInfo.LinePosition);
