...
namespace uml4net.xmi.Readers
{
    ...
    public class ReclassifyObjectActionReader : XmiElementReader<IReclassifyObjectAction>, IXmiElementReader<IReclassifyObjectAction>
    {
        ...
        /// </param>
        public ReclassifyObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IReclassifyObjectAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var newClassifierXmlAttribute = xmlReader.GetAttribute("newClassifier");
                ...
                var oldClassifierXmlAttribute = xmlReader.GetAttribute("oldClassifier");
