...
namespace uml4net.xmi.Readers.Deployments
{
    ...
    public class CommunicationPathReader : XmiElementReader<ICommunicationPath>, IXmiElementReader<ICommunicationPath>
    {
        ...
        /// </param>
        public CommunicationPathReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ICommunicationPath Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var memberEnd = new List<string>();
                var navigableOwnedEnd = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isLeaf":
                                ...
                                break;
                            case "memberEnd":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, memberEnd, "memberEnd");
                                break;
                            case "name":
                            ...
                            case "navigableOwnedEnd":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, navigableOwnedEnd, "navigableOwnedEnd");
                                break;
                            case "ownedComment":
                                ...
                                break;
                            case "ownedEnd":
                                var ownedEnd = (IProperty)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Property");
                            ...
                            default:
                                ...
                                throw new NotSupportedException($"CommunicationPathReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }

                if (memberEnd.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("memberEnd", memberEnd);
                }

                if (navigableOwnedEnd.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("navigableOwnedEnd", navigableOwnedEnd);
                }
