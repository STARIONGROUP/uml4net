...
namespace uml4net.xmi.Readers
{
    ...
    public class CommunicationPathReader : XmiElementReader<ICommunicationPath>, IXmiElementReader<ICommunicationPath>
    {
        ...
        /// </param>
        public CommunicationPathReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
