...
namespace uml4net.xmi.Readers
{
    ...
    public class ExtensionEndReader : XmiElementReader<IExtensionEnd>, IXmiElementReader<IExtensionEnd>
    {
        ...
        /// The (injected) logger
        /// </summary>
        private readonly ILogger<ExtensionEndReader> logger;
        ...
        /// </param>
        public ExtensionEndReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IExtenderReaderRegistry extenderReaderRegistry, ILoggerFactory loggerFactory)
            : base(cache, xmiElementReaderFacade, xmiReaderSettings, nameSpaceResolver, extenderReaderRegistry, loggerFactory)
        {
            this.logger = loggerFactory == null ? NullLogger<ExtensionEndReader>.Instance : loggerFactory.CreateLogger<ExtensionEndReader>();
        }
        ...
        /// The name of the document that contains the <see cref="IExtensionEnd"/>
        /// </param>
        /// <param name="namespaceUri">
        /// the namespace that the <see cref="IExtensionEnd"/> belongs to
        /// </param>
        /// <returns>
        /// an instance of <see cref="IExtensionEnd"/>
        /// </returns>
        public override IExtensionEnd Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            {
                this.logger.LogTrace("reading ExtensionEnd at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                ...
                if (!this.Cache.TryAdd(poco))
                {
                    ...
                    this.logger.LogError("The xmi:id is not unique within the document, the element that was read first is kept: ExtensionEnd [{XmiId}] property [xmi:id] at line:position {LineNumber}:{LinePosition}", poco.XmiId, xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                }
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            case (KnowNamespacePrefixes.Uml, "aggregation"):
                                var aggregationValue = xmlReader.ReadElementContentAsStringInPlace();
                            ...
                            case (KnowNamespacePrefixes.Uml, "association"):
                                CollectSingleValueReferencePropertyIdentifier(xmlReader, poco, "association");
                                break;
                            case (KnowNamespacePrefixes.Uml, "associationEnd"):
                                CollectSingleValueReferencePropertyIdentifier(xmlReader, poco, "associationEnd");
                                break;
                            ...
                            case (KnowNamespacePrefixes.Uml, "isDerivedUnion"):
                                var isDerivedUnionValue = xmlReader.ReadElementContentAsStringInPlace();
                            ...
                            case (KnowNamespacePrefixes.Uml, "isID"):
                                var isIDValue = xmlReader.ReadElementContentAsStringInPlace();
                            ...
                            case (KnowNamespacePrefixes.Uml, "isStatic"):
                                var isStaticValue = xmlReader.ReadElementContentAsStringInPlace();
                            ...
                            case (KnowNamespacePrefixes.Uml, "owningAssociation"):
                                CollectSingleValueReferencePropertyIdentifier(xmlReader, poco, "owningAssociation");
                                break;
                            ...
                            case (KnowNamespacePrefixes.Uml, "qualifier"):
                                if (!TryCollectCompositeReferencePropertyIdentifier(xmlReader, poco, "qualifier", poco.Qualifier.Count))
                                {
                            ...
                            case (KnowNamespacePrefixes.Uml, "redefinedProperty"):
                                TryCollectMultiValueReferencePropertyIdentifiers(xmlReader, poco, "redefinedProperty");
                                break;
                            case (KnowNamespacePrefixes.Uml, "subsettedProperty"):
                                TryCollectMultiValueReferencePropertyIdentifiers(xmlReader, poco, "subsettedProperty");
                                break;
                            ...
                            case (KnowNamespacePrefixes.Uml, "featuringClassifier"):
                            case (KnowNamespacePrefixes.Uml, "isComposite"):
                            case (KnowNamespacePrefixes.Uml, "lower"):
                            case (KnowNamespacePrefixes.Uml, "namespace"):
                            case (KnowNamespacePrefixes.Uml, "opposite"):
                            ...
                            case (KnowNamespacePrefixes.Uml, "upper"):
                                ...
                                this.logger.LogDebug("Ignoring the serialized derived property {LocalName} of ExtensionEnd at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, xmlLineInfo.LineNumber, xmlLineInfo.LinePosition);
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"ExtensionEndReader: {xmlReader.LocalName} at line:position {xmlLineInfo.LineNumber}:{xmlLineInfo.LinePosition}");
                                }
                                else
                                {
                                    this.logger.LogWarning("Not Supported: ExtensionEndReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, xmlLineInfo.LineNumber, xmlLineInfo.LinePosition);
