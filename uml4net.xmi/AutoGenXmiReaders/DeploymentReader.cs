...
namespace uml4net.xmi.Readers
{
    ...
    public class DeploymentReader : XmiElementReader<IDeployment>, IXmiElementReader<IDeployment>
    {
        ...
        /// </param>
        public DeploymentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            case (KnowNamespacePrefixes.Uml, "configuration"):
                                var configurationValue = (IDeploymentSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:DeploymentSpecification");
