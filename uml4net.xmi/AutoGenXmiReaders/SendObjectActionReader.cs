...
namespace uml4net.xmi.Readers
{
    ...
    public class SendObjectActionReader : XmiElementReader<ISendObjectAction>, IXmiElementReader<ISendObjectAction>
    {
        ...
        /// </param>
        public SendObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "request":
                                var requestValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
                            ...
                            default:
                                ...
                                {
                                    this.Logger.LogWarning("Not Supported: SendObjectActionReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
