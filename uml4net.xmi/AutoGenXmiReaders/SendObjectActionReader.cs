...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class SendObjectActionReader : XmiElementReader<ISendObjectAction>, IXmiElementReader<ISendObjectAction>
    {
        ...
        /// </param>
        public SendObjectActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ISendObjectAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "request":
                                var request = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.Request.Add(request);
                                break;
                            case "target":
