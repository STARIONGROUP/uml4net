...
namespace uml4net.xmi.Readers
{
    ...
    public class AnyReceiveEventReader : XmiElementReader<IAnyReceiveEvent>, IXmiElementReader<IAnyReceiveEvent>
    {
        ...
        /// </param>
        public AnyReceiveEventReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
