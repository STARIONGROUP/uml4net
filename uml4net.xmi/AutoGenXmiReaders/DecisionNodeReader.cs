...
namespace uml4net.xmi.Readers
{
    ...
    public class DecisionNodeReader : XmiElementReader<IDecisionNode>, IXmiElementReader<IDecisionNode>
    {
        ...
        /// </param>
        public DecisionNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
