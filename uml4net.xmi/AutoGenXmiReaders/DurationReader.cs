...
namespace uml4net.xmi.Readers
{
    ...
    public class DurationReader : XmiElementReader<IDuration>, IXmiElementReader<IDuration>
    {
        ...
        /// </param>
        public DurationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
