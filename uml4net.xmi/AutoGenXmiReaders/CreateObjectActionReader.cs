...
namespace uml4net.xmi.Readers
{
    ...
    public class CreateObjectActionReader : XmiElementReader<ICreateObjectAction>, IXmiElementReader<ICreateObjectAction>
    {
        ...
        /// </param>
        public CreateObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"CreateObjectActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
