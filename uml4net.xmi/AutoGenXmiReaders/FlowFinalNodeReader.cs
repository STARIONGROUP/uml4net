...
namespace uml4net.xmi.Readers
{
    ...
    public class FlowFinalNodeReader : XmiElementReader<IFlowFinalNode>, IXmiElementReader<IFlowFinalNode>
    {
        ...
        /// </param>
        public FlowFinalNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
