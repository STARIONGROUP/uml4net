...
namespace uml4net.xmi.Readers
{
    ...
    public class DurationIntervalReader : XmiElementReader<IDurationInterval>, IXmiElementReader<IDurationInterval>
    {
        ...
        /// </param>
        public DurationIntervalReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
