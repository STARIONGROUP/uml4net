                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "formal":
                                ...
                                break;
                            case "ownedActual":
                                var ownedActual = (IParameterableElement)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
                                poco.OwnedActual.Add(ownedActual);
                                break;
                            case "ownedComment":
