...
namespace uml4net.xmi.Readers
{
    ...
    public class FunctionBehaviorReader : XmiElementReader<IFunctionBehavior>, IXmiElementReader<IFunctionBehavior>
    {
        ...
        /// </param>
        public FunctionBehaviorReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        public override IFunctionBehavior Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    throw new NotSupportedException("DataTypes encoded as XML attributes are not (yet) supported: FunctionBehavior.body");
                }
                ...
                {
                    throw new NotSupportedException("DataTypes encoded as XML attributes are not (yet) supported: FunctionBehavior.language");
                }
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "postcondition":
                                ...
                                {
                                    this.Logger.LogWarning("The FunctionBehavior.Postcondition attribute was not processed at {DefaultLineInfo}", defaultLineInfo);
                                }
                                break;
                            ...
                            case "precondition":
                                ...
                                {
                                    this.Logger.LogWarning("The FunctionBehavior.Precondition attribute was not processed at {DefaultLineInfo}", defaultLineInfo);
                                }
                                break;
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"FunctionBehaviorReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
