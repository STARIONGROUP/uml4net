...
namespace uml4net.xmi.Readers
{
    ...
    public class LiteralNullReader : XmiElementReader<ILiteralNull>, IXmiElementReader<ILiteralNull>
    {
        ...
        /// </param>
        public LiteralNullReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
