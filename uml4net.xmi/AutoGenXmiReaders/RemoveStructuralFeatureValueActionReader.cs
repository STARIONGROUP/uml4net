...
namespace uml4net.xmi.Readers
{
    ...
    public class RemoveStructuralFeatureValueActionReader : XmiElementReader<IRemoveStructuralFeatureValueAction>, IXmiElementReader<IRemoveStructuralFeatureValueAction>
    {
        ...
        /// </param>
        public RemoveStructuralFeatureValueActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IRemoveStructuralFeatureValueAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var isRemoveDuplicatesXmlAttribute = xmlReader.GetAttribute("isRemoveDuplicates");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "object":
                                var objectValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "removeAt":
                                var removeAtValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
                            ...
                            case "structuralFeature":
                                ...
                                break;
                            case "value":
                                var valueValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
