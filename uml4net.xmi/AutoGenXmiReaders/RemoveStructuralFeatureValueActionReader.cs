// -------------------------------------------------------------------------------------------------
// <copyright file="RemoveStructuralFeatureValueActionReader.cs" company="Starion Group S.A.">
//
...
namespace uml4net.xmi.Readers
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RemoveStructuralFeatureValueActionReader"/> is to read an instance of <see cref="IRemoveStructuralFeatureValueAction"/>
    /// from the XMI document
    /// </summary>
    [GeneratedCode("uml4net", "latest")]
    public class RemoveStructuralFeatureValueActionReader : XmiElementReader<IRemoveStructuralFeatureValueAction>, IXmiElementReader<IRemoveStructuralFeatureValueAction>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        private readonly ILogger<RemoveStructuralFeatureValueActionReader> logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveStructuralFeatureValueActionReader"/> class.
        /// </summary>
        /// <param name="cache">
        ...
        /// </param>
        public RemoveStructuralFeatureValueActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
            : base(cache, xmiElementReaderFacade, xmiReaderSettings, nameSpaceResolver, loggerFactory)
        {
            this.logger = loggerFactory == null ? NullLogger<RemoveStructuralFeatureValueActionReader>.Instance : loggerFactory.CreateLogger<RemoveStructuralFeatureValueActionReader>();
        }

        /// <summary>
        /// Reads the <see cref="IRemoveStructuralFeatureValueAction"/> object from its XML representation
        /// </summary>
        /// <param name="xmlReader">
        /// an instance of <see cref="XmlReader"/>
        /// </param>
        /// <param name="documentName">
        /// The name of the document that contains the <see cref="IRemoveStructuralFeatureValueAction"/>
        /// </param>
        /// <param name="namespaceUri">
        /// the namespace that the <see cref="IRemoveStructuralFeatureValueAction"/> belongs to
        /// </param>
        /// <returns>
        /// an instance of <see cref="IRemoveStructuralFeatureValueAction"/>
        /// </returns>
        public override IRemoveStructuralFeatureValueAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            IRemoveStructuralFeatureValueAction poco = new RemoveStructuralFeatureValueAction();

            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                this.logger.LogTrace("reading RemoveStructuralFeatureValueAction at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);

                var xmiType = xmlReader.GetAttribute("type", this.NameSpaceResolver.XmiNameSpace);

                if (!string.IsNullOrEmpty(xmiType) && xmiType != "uml:RemoveStructuralFeatureValueAction")
                {
                    throw new XmlException($"The XmiType should be 'uml:RemoveStructuralFeatureValueAction' while it is {xmiType}");
                }
                else
                {
                    xmiType = "uml:RemoveStructuralFeatureValueAction";
                }
                ...
                {
                    this.logger.LogCritical("Failed to add element type [{Poco}] with id [{Id}] as it was already in the Cache. The XMI document seems to have duplicate xmi:id values", "RemoveStructuralFeatureValueAction", poco.XmiId);
                }
                ...
                var isRemoveDuplicatesXmlAttribute = xmlReader.GetAttribute("isRemoveDuplicates") ?? xmlReader.GetAttribute("isRemoveDuplicates", this.NameSpaceResolver.UmlNameSpace);

                if (!string.IsNullOrWhiteSpace(isRemoveDuplicatesXmlAttribute))
                {
                    poco.IsRemoveDuplicates = bool.Parse(isRemoveDuplicatesXmlAttribute);
                }
                ...
                var structuralFeatureXmlAttribute = xmlReader.GetAttribute("structuralFeature") ?? xmlReader.GetAttribute("structuralFeature", this.NameSpaceResolver.UmlNameSpace);

                if (!string.IsNullOrWhiteSpace(structuralFeatureXmlAttribute))
                {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            case (KnowNamespacePrefixes.Uml, "handler"):
                                var handlerValue = (IExceptionHandler)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:ExceptionHandler");
                            ...
                            case (KnowNamespacePrefixes.Uml, "isLocallyReentrant"):
                                ...
                                break;
                            case (KnowNamespacePrefixes.Uml, "isRemoveDuplicates"):
                                var isRemoveDuplicatesValue = xmlReader.ReadElementContentAsString();

                                if (!string.IsNullOrWhiteSpace(isRemoveDuplicatesValue))
                                {
                                    poco.IsRemoveDuplicates = bool.Parse(isRemoveDuplicatesValue);
                                }

                                break;
                            case (KnowNamespacePrefixes.Uml, "localPostcondition"):
                                var localPostconditionValue = (IConstraint)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:Constraint");
                                poco.LocalPostcondition.Add(localPostconditionValue);
                                break;
                            case (KnowNamespacePrefixes.Uml, "localPrecondition"):
                                var localPreconditionValue = (IConstraint)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:Constraint");
                            ...
                            case (KnowNamespacePrefixes.Uml, "object"):
                                var objectValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:InputPin");
                            ...
                            case (KnowNamespacePrefixes.Uml, "redefinedNode"):
                                ...
                                break;
                            case (KnowNamespacePrefixes.Uml, "removeAt"):
                                var removeAtValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:InputPin");
                                poco.RemoveAt.Add(removeAtValue);
                                break;
                            case (KnowNamespacePrefixes.Uml, "result"):
                                var resultValue = (IOutputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:OutputPin");
                            ...
                            case (KnowNamespacePrefixes.Uml, "value"):
                                var valueValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:InputPin");
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"RemoveStructuralFeatureValueActionReader: {xmlReader.LocalName} at line:position {xmlLineInfo.LineNumber}:{xmlLineInfo.LinePosition}");
                                }
                                else
                                {
                                    this.logger.LogWarning("Not Supported: RemoveStructuralFeatureValueActionReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, xmlLineInfo.LineNumber, xmlLineInfo.LinePosition);
                                }
