...
namespace uml4net.xmi.Readers
{
    ...
    public class AddStructuralFeatureValueActionReader : XmiElementReader<IAddStructuralFeatureValueAction>, IXmiElementReader<IAddStructuralFeatureValueAction>
    {
        ...
        /// The (injected) logger
        /// </summary>
        private readonly ILogger<AddStructuralFeatureValueActionReader> logger;
        ...
        /// </param>
        public AddStructuralFeatureValueActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
            : base(cache, xmiElementReaderFacade, xmiReaderSettings, nameSpaceResolver, loggerFactory)
        {
            this.logger = loggerFactory == null ? NullLogger<AddStructuralFeatureValueActionReader>.Instance : loggerFactory.CreateLogger<AddStructuralFeatureValueActionReader>();
        }
        ...
        /// The name of the document that contains the <see cref="IAddStructuralFeatureValueAction"/>
        /// </param>
        /// <param name="namespaceUri">
        /// the namespace that the <see cref="IAddStructuralFeatureValueAction"/> belongs to
        /// </param>
        /// <returns>
        /// an instance of <see cref="IAddStructuralFeatureValueAction"/>
        /// </returns>
        public override IAddStructuralFeatureValueAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            if (xmlReader == null)
            {
            ...
            {
                this.logger.LogTrace("reading AddStructuralFeatureValueAction at line:position {LineNumber}:{LinePosition}", xmlLineInfo?.LineNumber, xmlLineInfo?.LinePosition);
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"AddStructuralFeatureValueActionReader: {xmlReader.LocalName} at line:position {xmlLineInfo.LineNumber}:{xmlLineInfo.LinePosition}");
                                }
                                else
                                {
