...
namespace uml4net.xmi.Readers
{
    ...
    public class RemoveVariableValueActionReader : XmiElementReader<IRemoveVariableValueAction>, IXmiElementReader<IRemoveVariableValueAction>
    {
        ...
        /// </returns>
        public override IRemoveVariableValueAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "removeAt":
                                var removeAtValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
