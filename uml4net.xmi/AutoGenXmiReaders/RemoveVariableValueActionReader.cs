...
namespace uml4net.xmi.Readers
{
    ...
    public class RemoveVariableValueActionReader : XmiElementReader<IRemoveVariableValueAction>, IXmiElementReader<IRemoveVariableValueAction>
    {
        ...
        /// </param>
        public RemoveVariableValueActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"RemoveVariableValueActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
