...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class RemoveVariableValueActionReader : XmiElementReader<IRemoveVariableValueAction>, IXmiElementReader<IRemoveVariableValueAction>
    {
        ...
        /// </param>
        public RemoveVariableValueActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "isRemoveDuplicates":
                                var isRemoveDuplicatesXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(isRemoveDuplicatesXmlElement))
                                {
                                    poco.IsRemoveDuplicates = bool.Parse(isRemoveDuplicatesXmlElement);
                                }
                                break;
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "removeAt":
                                var removeAt = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.RemoveAt.Add(removeAt);
                                break;
                            case "value":
                                var value = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.Value.Add(value);
                                break;
                            case "variable":
