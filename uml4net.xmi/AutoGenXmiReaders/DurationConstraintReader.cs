...
namespace uml4net.xmi.Readers
{
    ...
    public class DurationConstraintReader : XmiElementReader<IDurationConstraint>, IXmiElementReader<IDurationConstraint>
    {
        ...
        /// </param>
        public DurationConstraintReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            ...
                            case (KnowNamespacePrefixes.Uml, "specification"):
                                var specificationValue = (IDurationInterval)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory, "uml:DurationInterval");
