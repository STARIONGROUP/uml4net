...
namespace uml4net.xmi.Readers
{
    ...
    public class DurationConstraintReader : XmiElementReader<IDurationConstraint>, IXmiElementReader<IDurationConstraint>
    {
        ...
        /// </returns>
        public override IDurationConstraint Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "owningTemplateParameter":
                                ...
                                break;
                            case "specification":
                                var specificationValue = (IDurationInterval)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:DurationInterval");
