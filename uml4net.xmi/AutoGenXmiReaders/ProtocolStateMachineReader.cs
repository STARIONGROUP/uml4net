    ...
    public class ProtocolStateMachineReader : XmiElementReader<IProtocolStateMachine>, IXmiElementReader<IProtocolStateMachine>
    {
        ...
        public override IProtocolStateMachine Read(XmlReader xmlReader)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "collaborationUse":
                                ...
                                break;
                            case "conformance":
                                var conformance = (IProtocolConformance)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:ProtocolConformance");
                                poco.Conformance.Add(conformance);
                                break;
                            ...
                            case "extendedStateMachine":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, extendedStateMachine, "extendedStateMachine");
                                break;
                            case "generalization":
                            ...
                            case "submachineState":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, submachineState, "submachineState");
                                break;
                            case "substitution":
                ...
                if (extendedStateMachine.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("extendedStateMachine", extendedStateMachine);
                }
                ...
                if (submachineState.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("submachineState", submachineState);
                }
