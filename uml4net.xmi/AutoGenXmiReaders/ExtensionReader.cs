...
namespace uml4net.xmi.Readers.Packages
{
    ...
    public class ExtensionReader : XmiElementReader<IExtension>, IXmiElementReader<IExtension>
    {
        ...
        /// </param>
        public ExtensionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IExtension Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComment":
                                ...
                                break;
                            case "ownedEnd":
                                var ownedEnd = (IExtensionEnd)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:ExtensionEnd");
