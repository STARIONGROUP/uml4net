...
namespace uml4net.xmi.Readers
{
    ...
    public class ExtensionReader : XmiElementReader<IExtension>, IXmiElementReader<IExtension>
    {
        ...
        /// </param>
        public ExtensionReader(IXmiElementCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComment":
                                ...
                                break;
                            case "ownedEnd":
                                var ownedEndValue = (IExtensionEnd)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:ExtensionEnd");
