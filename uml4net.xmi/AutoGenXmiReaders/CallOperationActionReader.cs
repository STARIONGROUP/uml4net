...
namespace uml4net.xmi.Readers
{
    ...
    public class CallOperationActionReader : XmiElementReader<ICallOperationAction>, IXmiElementReader<ICallOperationAction>
    {
        ...
        /// </param>
        public CallOperationActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"CallOperationActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
