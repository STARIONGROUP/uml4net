...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class CallOperationActionReader : XmiElementReader<ICallOperationAction>, IXmiElementReader<ICallOperationAction>
    {
        ...
        /// </param>
        public CallOperationActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ICallOperationAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "argument":
                                var argument = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                            ...
                            case "isLocallyReentrant":
                                ...
                                break;
                            case "isSynchronous":
                                var isSynchronousXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(isSynchronousXmlElement))
                                {
                                    poco.IsSynchronous = bool.Parse(isSynchronousXmlElement);
                                }
                                break;
