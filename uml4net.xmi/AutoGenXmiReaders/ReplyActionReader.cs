                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "replyToCall":
                                ...
                                break;
                            case "replyValue":
                                var replyValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.ReplyValue.Add(replyValue);
                                break;
                            case "returnInformation":
                                var returnInformation = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.ReturnInformation.Add(returnInformation);
                                break;
                            case "visibility":
