...
namespace uml4net.xmi.Readers
{
    ...
    public class ReplyActionReader : XmiElementReader<IReplyAction>, IXmiElementReader<IReplyAction>
    {
        ...
        /// </param>
        public ReplyActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "replyToCall":
                                ...
                                break;
                            case "replyValue":
                                var replyValueValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.ReplyValue.Add(replyValueValue);
                                break;
                            case "returnInformation":
                                var returnInformationValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:InputPin");
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReplyActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
