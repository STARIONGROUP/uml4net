...
namespace uml4net.xmi.Readers
{
    ...
    public class ReplyActionReader : XmiElementReader<IReplyAction>, IXmiElementReader<IReplyAction>
    {
        ...
        /// </returns>
        public override IReplyAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "replyToCall":
                                ...
                                break;
                            case "replyValue":
                                var replyValueValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.ReplyValue.Add(replyValueValue);
                                break;
                            case "returnInformation":
                                var returnInformationValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
