...
namespace uml4net.xmi.Readers
{
    ...
    public class ReplyActionReader : XmiElementReader<IReplyAction>, IXmiElementReader<IReplyAction>
    {
        ...
        /// </param>
        public ReplyActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IReplyAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var replyToCallXmlAttribute = xmlReader.GetAttribute("replyToCall");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "replyToCall":
                                ...
                                break;
                            case "replyValue":
                                var replyValueValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
                                poco.ReplyValue.Add(replyValueValue);
                                break;
                            case "returnInformation":
                                var returnInformationValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
