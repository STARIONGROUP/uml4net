...
namespace uml4net.xmi.Readers
{
    ...
    public class ExecutionEnvironmentReader : XmiElementReader<IExecutionEnvironment>, IXmiElementReader<IExecutionEnvironment>
    {
        ...
        /// </param>
        public ExecutionEnvironmentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
