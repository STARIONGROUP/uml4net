...
namespace uml4net.xmi.Readers
{
    ...
    public class StartClassifierBehaviorActionReader : XmiElementReader<IStartClassifierBehaviorAction>, IXmiElementReader<IStartClassifierBehaviorAction>
    {
        ...
        /// </param>
        public StartClassifierBehaviorActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"StartClassifierBehaviorActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
