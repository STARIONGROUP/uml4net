...
namespace uml4net.xmi.Readers
{
    ...
    public class ClearStructuralFeatureActionReader : XmiElementReader<IClearStructuralFeatureAction>, IXmiElementReader<IClearStructuralFeatureAction>
    {
        ...
        /// </param>
        public ClearStructuralFeatureActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ClearStructuralFeatureActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
