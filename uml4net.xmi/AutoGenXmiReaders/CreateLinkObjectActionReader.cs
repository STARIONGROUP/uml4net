...
namespace uml4net.xmi.Readers
{
    ...
    public class CreateLinkObjectActionReader : XmiElementReader<ICreateLinkObjectAction>, IXmiElementReader<ICreateLinkObjectAction>
    {
        ...
        /// </param>
        public CreateLinkObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndCreationData)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:LinkEndCreationData");
