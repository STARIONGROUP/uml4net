...
namespace uml4net.xmi.Readers
{
    ...
    public class InterfaceRealizationReader : XmiElementReader<IInterfaceRealization>, IXmiElementReader<IInterfaceRealization>
    {
        ...
        /// </param>
        public InterfaceRealizationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
