...
namespace uml4net.xmi.Readers
{
    ...
    public class InformationFlowReader : XmiElementReader<IInformationFlow>, IXmiElementReader<IInformationFlow>
    {
        ...
        /// </param>
        public InformationFlowReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
