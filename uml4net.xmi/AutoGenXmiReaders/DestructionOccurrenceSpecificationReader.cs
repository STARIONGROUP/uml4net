...
namespace uml4net.xmi.Readers
{
    ...
    public class DestructionOccurrenceSpecificationReader : XmiElementReader<IDestructionOccurrenceSpecification>, IXmiElementReader<IDestructionOccurrenceSpecification>
    {
        ...
        /// </param>
        public DestructionOccurrenceSpecificationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
