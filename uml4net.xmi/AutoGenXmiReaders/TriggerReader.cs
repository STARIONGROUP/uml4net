...
namespace uml4net.xmi.Readers
{
    ...
    public class TriggerReader : XmiElementReader<ITrigger>, IXmiElementReader<ITrigger>
    {
        ...
        /// </param>
        public TriggerReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
