...
namespace uml4net.xmi.Readers
{
    ...
    public class ExpansionRegionReader : XmiElementReader<IExpansionRegion>, IXmiElementReader<IExpansionRegion>
    {
        ...
        /// </param>
        public ExpansionRegionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
