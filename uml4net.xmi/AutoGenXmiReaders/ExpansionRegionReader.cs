    ...
    public class ExpansionRegionReader : XmiElementReader<IExpansionRegion>, IXmiElementReader<IExpansionRegion>
    {
        ...
        public override IExpansionRegion Read(XmlReader xmlReader)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var inputElement = new List<string>();
                var outgoing = new List<string>();
                var outputElement = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "inPartition":
                                ...
                                break;
                            case "inputElement":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, inputElement, "inputElement");
                                break;
                            ...
                            case "localPrecondition":
                                ...
                                break;
                            case "mode":
                                var modeXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(modeXmlElement))
                                {
                                    poco.Mode = (ExpansionKind)Enum.Parse(typeof(ExpansionKind), modeXmlElement, true); ;
                                }
                                break;
                            case "mustIsolate":
                            ...
                            case "outgoing":
                                ...
                                break;
                            case "outputElement":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, outputElement, "outputElement");
                                break;
                            case "ownedComment":
                ...
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("inputElement", inputElement);
                }
                ...
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("outputElement", outputElement);
                }
