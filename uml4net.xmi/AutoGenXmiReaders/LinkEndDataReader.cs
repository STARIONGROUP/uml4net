...
namespace uml4net.xmi.Readers
{
    ...
    public class LinkEndDataReader : XmiElementReader<ILinkEndData>, IXmiElementReader<ILinkEndData>
    {
        ...
        /// </param>
        public LinkEndDataReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
