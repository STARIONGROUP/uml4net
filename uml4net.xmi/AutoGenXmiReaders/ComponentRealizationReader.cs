...
namespace uml4net.xmi.Readers.StructuredClassifiers
{
    ...
    public class ComponentRealizationReader : XmiElementReader<IComponentRealization>, IXmiElementReader<IComponentRealization>
    {
        ...
        /// </param>
        public ComponentRealizationReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IComponentRealization Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var realizingClassifier = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "realizingClassifier":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, realizingClassifier, "realizingClassifier");
                                break;
                            case "supplier":
                ...
                if (realizingClassifier.Count > 0)
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("realizingClassifier", realizingClassifier);
                }
