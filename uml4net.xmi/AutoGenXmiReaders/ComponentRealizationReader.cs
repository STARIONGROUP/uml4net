...
namespace uml4net.xmi.Readers
{
    ...
    public class ComponentRealizationReader : XmiElementReader<IComponentRealization>, IXmiElementReader<IComponentRealization>
    {
        ...
        /// </param>
        public ComponentRealizationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IComponentRealization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var abstractionXmlAttribute = xmlReader.GetAttribute("abstraction");
                ...
                var realizingClassifierXmlAttribute = xmlReader.GetAttribute("realizingClassifier");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"ComponentRealizationReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                                }
                                else
                                {
                                    this.Logger.LogWarning("Not Supported: ComponentRealizationReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
                                break;
                        }
                    }
