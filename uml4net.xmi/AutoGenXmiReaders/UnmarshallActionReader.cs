...
namespace uml4net.xmi.Readers
{
    ...
    public class UnmarshallActionReader : XmiElementReader<IUnmarshallAction>, IXmiElementReader<IUnmarshallAction>
    {
        ...
        /// </param>
        public UnmarshallActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        public override IUnmarshallAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var unmarshallTypeXmlAttribute = xmlReader.GetAttribute("unmarshallType");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"UnmarshallActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
