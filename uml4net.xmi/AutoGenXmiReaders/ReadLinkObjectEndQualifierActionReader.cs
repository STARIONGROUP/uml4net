...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadLinkObjectEndQualifierActionReader : XmiElementReader<IReadLinkObjectEndQualifierAction>, IXmiElementReader<IReadLinkObjectEndQualifierAction>
    {
        ...
        /// </param>
        public ReadLinkObjectEndQualifierActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadLinkObjectEndQualifierActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
