...
namespace uml4net.xmi.Readers.CommonBehavior
{
    ...
    public class ChangeEventReader : XmiElementReader<IChangeEvent>, IXmiElementReader<IChangeEvent>
    {
        ...
        /// </param>
        public ChangeEventReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "changeExpression":
                                var changeExpression = (IValueSpecification)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
                                poco.ChangeExpression.Add(changeExpression);
                                break;
                            case "name":
