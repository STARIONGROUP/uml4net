...
namespace uml4net.xmi.Readers
{
    ...
    public class ActivityFinalNodeReader : XmiElementReader<IActivityFinalNode>, IXmiElementReader<IActivityFinalNode>
    {
        ...
        /// </param>
        public ActivityFinalNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
