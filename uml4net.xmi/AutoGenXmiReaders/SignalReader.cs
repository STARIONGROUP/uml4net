...
namespace uml4net.xmi.Readers
{
    ...
    public class SignalReader : XmiElementReader<ISignal>, IXmiElementReader<ISignal>
    {
        ...
        /// </param>
        public SignalReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
