...
namespace uml4net.xmi.Readers
{
    ...
    public class DestroyObjectActionReader : XmiElementReader<IDestroyObjectAction>, IXmiElementReader<IDestroyObjectAction>
    {
        ...
        /// </param>
        public DestroyObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IDestroyObjectAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var isDestroyLinksXmlAttribute = xmlReader.GetAttribute("isDestroyLinks");
                ...
                var isDestroyOwnedObjectsXmlAttribute = xmlReader.GetAttribute("isDestroyOwnedObjects");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "redefinedNode":
                                ...
                                break;
                            case "target":
                                var targetValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:InputPin");
