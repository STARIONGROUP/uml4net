...
namespace uml4net.xmi.Readers
{
    ...
    public class StateInvariantReader : XmiElementReader<IStateInvariant>, IXmiElementReader<IStateInvariant>
    {
        ...
        /// </param>
        public StateInvariantReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "generalOrdering":
                                ...
                                break;
                            case "invariant":
                                var invariantValue = (IConstraint)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:Constraint");
