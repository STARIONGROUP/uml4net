...
namespace uml4net.xmi.Readers
{
    ...
    public class ExpressionReader : XmiElementReader<IExpression>, IXmiElementReader<IExpression>
    {
        ...
        /// </param>
        public ExpressionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nameExpression":
                                ...
                                break;
                            case "operand":
                                var operandValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory);
