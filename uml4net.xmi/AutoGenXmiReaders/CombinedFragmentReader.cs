...
namespace uml4net.xmi.Readers
{
    ...
    public class CombinedFragmentReader : XmiElementReader<ICombinedFragment>, IXmiElementReader<ICombinedFragment>
    {
        ...
        /// </param>
        public CombinedFragmentReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
        ...
        public override ICombinedFragment Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    this.logger.LogCritical("Failed to add element type [{Poco}] with id [{Id}] as it was already in the Cache. The XMI document seems to have duplicate xmi:id values", "CombinedFragment", poco.XmiId);
                }
