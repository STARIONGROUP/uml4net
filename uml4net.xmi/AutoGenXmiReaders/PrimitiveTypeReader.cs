...
namespace uml4net.xmi.Readers
{
    ...
    public class PrimitiveTypeReader : XmiElementReader<IPrimitiveType>, IXmiElementReader<IPrimitiveType>
    {
        ...
        /// </param>
        public PrimitiveTypeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
