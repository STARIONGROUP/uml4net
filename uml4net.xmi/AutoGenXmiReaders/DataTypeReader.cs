...
namespace uml4net.xmi.Readers
{
    ...
    public class DataTypeReader : XmiElementReader<IDataType>, IXmiElementReader<IDataType>
    {
        ...
        /// </param>
        public DataTypeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
