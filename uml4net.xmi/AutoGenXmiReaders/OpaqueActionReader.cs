                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "inPartition":
                                ...
                                break;
                            case "inputValue":
                                var inputValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.InputValue.Add(inputValue);
                                break;
                            ...
                            case "outgoing":
                                ...
                                break;
                            case "outputValue":
                                var outputValue = (IOutputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:OutputPin");
                                poco.OutputValue.Add(outputValue);
                                break;
                            case "ownedComment":
