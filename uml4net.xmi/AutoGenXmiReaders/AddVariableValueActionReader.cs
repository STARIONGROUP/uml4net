...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class AddVariableValueActionReader : XmiElementReader<IAddVariableValueAction>, IXmiElementReader<IAddVariableValueAction>
    {
        ...
        /// </param>
        public AddVariableValueActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IAddVariableValueAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "inPartition":
                                ...
                                break;
                            case "insertAt":
                                var insertAt = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
                                poco.InsertAt.Add(insertAt);
                                break;
