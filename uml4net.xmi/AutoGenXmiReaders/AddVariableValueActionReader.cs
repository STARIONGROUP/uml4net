...
namespace uml4net.xmi.Readers
{
    ...
    public class AddVariableValueActionReader : XmiElementReader<IAddVariableValueAction>, IXmiElementReader<IAddVariableValueAction>
    {
        ...
        /// </param>
        public AddVariableValueActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "inPartition":
                                ...
                                break;
                            case "insertAt":
                                var insertAtValue = (IInputPin)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:InputPin");
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"AddVariableValueActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
