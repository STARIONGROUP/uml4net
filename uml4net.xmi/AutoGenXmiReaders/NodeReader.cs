...
namespace uml4net.xmi.Readers
{
    ...
    public class NodeReader : XmiElementReader<INode>, IXmiElementReader<INode>
    {
        ...
        /// </param>
        public NodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
