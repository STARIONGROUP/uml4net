...
namespace uml4net.xmi.Readers
{
    ...
    public class ActorReader : XmiElementReader<IActor>, IXmiElementReader<IActor>
    {
        ...
        /// </param>
        public ActorReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
