...
namespace uml4net.xmi.Readers
{
    ...
    public class TimeIntervalReader : XmiElementReader<ITimeInterval>, IXmiElementReader<ITimeInterval>
    {
        ...
        /// </param>
        public TimeIntervalReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
