            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "actualGate":
                                var actualGate = (IGate)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Gate");
                                poco.ActualGate.Add(actualGate);
                                break;
                            case "argument":
                            ...
                            case "refersTo":
                                ...
                                break;
                            case "returnValue":
                                var returnValue = (IValueSpecification)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
                                poco.ReturnValue.Add(returnValue);
                                break;
