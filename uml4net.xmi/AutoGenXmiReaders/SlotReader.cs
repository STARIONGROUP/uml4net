...
namespace uml4net.xmi.Readers
{
    ...
    public class SlotReader : XmiElementReader<ISlot>, IXmiElementReader<ISlot>
    {
        ...
        /// </param>
        public SlotReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
