                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "event":
                                ...
                                break;
                            case "firstEvent":
                                var firstEventXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(firstEventXmlElement))
                                {
                                    poco.FirstEvent = bool.Parse(firstEventXmlElement);
                                }
                                break;
                            case "name":
