...
namespace uml4net.xmi.Readers
{
    ...
    public class TimeObservationReader : XmiElementReader<ITimeObservation>, IXmiElementReader<ITimeObservation>
    {
        ...
        /// </param>
        public TimeObservationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
