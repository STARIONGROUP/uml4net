...
namespace uml4net.xmi.Readers
{
    ...
    public class MergeNodeReader : XmiElementReader<IMergeNode>, IXmiElementReader<IMergeNode>
    {
        ...
        /// </param>
        public MergeNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
