                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "stateInvariant":
                                ...
                                {
                                    this.Logger.LogWarning("The FinalState.StateInvariant attribute was not processed at {DefaultLineInfo}", defaultLineInfo);
                                }
                                break;
                            case "submachine":
                            ...
                            default:
                                ...
                                {
                                    this.Logger.LogWarning("Not Supported: FinalStateReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
                                break;
                        }
                    }
