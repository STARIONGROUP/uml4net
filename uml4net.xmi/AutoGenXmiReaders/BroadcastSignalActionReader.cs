...
namespace uml4net.xmi.Readers
{
    ...
    public class BroadcastSignalActionReader : XmiElementReader<IBroadcastSignalAction>, IXmiElementReader<IBroadcastSignalAction>
    {
        ...
        /// </param>
        public BroadcastSignalActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"BroadcastSignalActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
