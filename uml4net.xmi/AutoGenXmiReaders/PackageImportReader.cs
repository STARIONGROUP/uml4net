...
namespace uml4net.xmi.Readers
{
    ...
    public class PackageImportReader : XmiElementReader<IPackageImport>, IXmiElementReader<IPackageImport>
    {
        ...
        /// </param>
        public PackageImportReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
