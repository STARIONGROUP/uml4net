...
namespace uml4net.xmi.Readers
{
    ...
    public class AcceptEventActionReader : XmiElementReader<IAcceptEventAction>, IXmiElementReader<IAcceptEventAction>
    {
        ...
        /// </param>
        public AcceptEventActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"AcceptEventActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
