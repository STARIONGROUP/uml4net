...
namespace uml4net.xmi.Readers
{
    ...
    public class ManifestationReader : XmiElementReader<IManifestation>, IXmiElementReader<IManifestation>
    {
        ...
        /// </param>
        public ManifestationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
