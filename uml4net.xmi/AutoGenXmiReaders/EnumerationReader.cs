...
namespace uml4net.xmi.Readers
{
    ...
    public class EnumerationReader : XmiElementReader<IEnumeration>, IXmiElementReader<IEnumeration>
    {
        ...
        /// </param>
        public EnumerationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "ownedComment":
                                ...
                                break;
                            case "ownedLiteral":
                                var ownedLiteralValue = (IEnumerationLiteral)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory, "uml:EnumerationLiteral");
