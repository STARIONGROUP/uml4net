...
namespace uml4net.xmi.Readers
{
    ...
    public class SequenceNodeReader : XmiElementReader<ISequenceNode>, IXmiElementReader<ISequenceNode>
    {
        ...
        /// </param>
        public SequenceNodeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "elementImport":
                                ...
                                break;
                            case "executableNode":
                                var executableNodeValue = (IExecutableNode)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory);
