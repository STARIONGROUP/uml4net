...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class SequenceNodeReader : XmiElementReader<ISequenceNode>, IXmiElementReader<ISequenceNode>
    {
        ...
        /// </param>
        public SequenceNodeReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ISequenceNode Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "elementImport":
                                ...
                                break;
                            case "executableNode":
                                var executableNode = (IExecutableNode)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
                                poco.ExecutableNode.Add(executableNode);
                                break;
                            case "handler":
