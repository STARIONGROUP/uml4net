...
namespace uml4net.xmi.Readers.InformationFlows
{
    ...
    public class InformationItemReader : XmiElementReader<IInformationItem>, IXmiElementReader<IInformationItem>
    {
        ...
        /// </param>
        public InformationItemReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
        ...
        public override IInformationItem Read(XmlReader xmlReader)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var represented = new List<string>();
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "representation":
                                ...
                                break;
                            case "represented":
                                this.CollectMultiValueReferencePropertyIdentifiers(xmlReader, represented, "represented");
                                break;
                            case "substitution":
                ...
                {
                    poco.MultiValueReferencePropertyIdentifiers.Add("represented", represented);
                }
