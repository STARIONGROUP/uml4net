...
namespace uml4net.xmi.Readers
{
    ...
    public class InstanceValueReader : XmiElementReader<IInstanceValue>, IXmiElementReader<IInstanceValue>
    {
        ...
        /// </param>
        public InstanceValueReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override IInstanceValue Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var instanceXmlAttribute = xmlReader.GetAttribute("instance");
