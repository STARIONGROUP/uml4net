...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class ActionInputPinReader : XmiElementReader<IActionInputPin>, IXmiElementReader<IActionInputPin>
    {
        ...
        /// </param>
        public ActionInputPinReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "fromAction":
                                var fromAction = (IAction)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
                                poco.FromAction.Add(fromAction);
                                break;
                            case "incoming":
