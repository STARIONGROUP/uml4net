...
namespace uml4net.xmi.Readers
{
    ...
    public class ActionInputPinReader : XmiElementReader<IActionInputPin>, IXmiElementReader<IActionInputPin>
    {
        ...
        /// </param>
        public ActionInputPinReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IActionInputPin Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "fromAction":
                                var fromActionValue = (IAction)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
