...
namespace uml4net.xmi.Readers.Actions
{
    ...
    public class ReadIsClassifiedObjectActionReader : XmiElementReader<IReadIsClassifiedObjectAction>, IXmiElementReader<IReadIsClassifiedObjectAction>
    {
        ...
        /// </param>
        public ReadIsClassifiedObjectActionReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "inStructuredNode":
                                ...
                                break;
                            case "isDirect":
                                var isDirectXmlElement = xmlReader.ReadElementContentAsString();
                                if (!string.IsNullOrEmpty(isDirectXmlElement))
                                {
                                    poco.IsDirect = bool.Parse(isDirectXmlElement);
                                }
                                break;
                            case "isLeaf":
