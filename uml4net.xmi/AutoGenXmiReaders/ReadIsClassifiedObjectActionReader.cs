...
namespace uml4net.xmi.Readers
{
    ...
    public class ReadIsClassifiedObjectActionReader : XmiElementReader<IReadIsClassifiedObjectAction>, IXmiElementReader<IReadIsClassifiedObjectAction>
    {
        ...
        /// </param>
        public ReadIsClassifiedObjectActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        public override IReadIsClassifiedObjectAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var isDirectXmlAttribute = xmlReader.GetAttribute("isDirect");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"ReadIsClassifiedObjectActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
