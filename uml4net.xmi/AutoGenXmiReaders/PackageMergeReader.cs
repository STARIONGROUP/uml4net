...
namespace uml4net.xmi.Readers
{
    ...
    public class PackageMergeReader : XmiElementReader<IPackageMerge>, IXmiElementReader<IPackageMerge>
    {
        ...
        /// </param>
        public PackageMergeReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IPackageMerge Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
