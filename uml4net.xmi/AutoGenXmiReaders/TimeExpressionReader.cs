...
namespace uml4net.xmi.Readers
{
    ...
    public class TimeExpressionReader : XmiElementReader<ITimeExpression>, IXmiElementReader<ITimeExpression>
    {
        ...
        /// </returns>
        public override ITimeExpression Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "expr":
                                var exprValue = (IValueSpecification)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory);
