...
namespace uml4net.xmi.Readers
{
    ...
    public class TimeExpressionReader : XmiElementReader<ITimeExpression>, IXmiElementReader<ITimeExpression>
    {
        ...
        /// </param>
        public TimeExpressionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                while (xmlReader.Read())
                {
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        {
                            case "expr":
                                var exprValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory);
