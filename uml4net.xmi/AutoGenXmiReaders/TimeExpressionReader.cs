...
namespace uml4net.xmi.Readers
{
    ...
    public class TimeExpressionReader : XmiElementReader<ITimeExpression>, IXmiElementReader<ITimeExpression>
    {
        ...
        /// </param>
        public TimeExpressionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        switch (activePrefix, xmlReader.LocalName)
                        {
                            case (KnowNamespacePrefixes.Uml, "expr"):
                                var exprValue = (IValueSpecification)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.NameSpaceResolver, this.LoggerFactory);
                            ...
                            case (KnowNamespacePrefixes.Uml, "observation"):
                                this.TryCollectMultiValueReferencePropertyIdentifiers(xmlReader, poco, "observation");
                                break;
