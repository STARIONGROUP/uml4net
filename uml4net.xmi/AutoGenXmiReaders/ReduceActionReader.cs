...
namespace uml4net.xmi.Readers
{
    ...
    public class ReduceActionReader : XmiElementReader<IReduceAction>, IXmiElementReader<IReduceAction>
    {
        ...
        /// </returns>
        public override IReduceAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "collection":
                                var collectionValue = (IInputPin)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:InputPin");
