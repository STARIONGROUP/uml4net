...
namespace uml4net.xmi.Readers
{
    ...
    public class CreateLinkActionReader : XmiElementReader<ICreateLinkAction>, IXmiElementReader<ICreateLinkAction>
    {
        ...
        /// </param>
        public CreateLinkActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"CreateLinkActionReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
