...
namespace uml4net.xmi.Readers
{
    ...
    public class CreateLinkActionReader : XmiElementReader<ICreateLinkAction>, IXmiElementReader<ICreateLinkAction>
    {
        ...
        /// </param>
        public CreateLinkActionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
        ...
        public override ICreateLinkAction Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                {
                    this.logger.LogCritical("Failed to add element type [{Poco}] with id [{Id}] as it was already in the Cache. The XMI document seems to have duplicate xmi:id values", "CreateLinkAction", poco.XmiId);
                }
