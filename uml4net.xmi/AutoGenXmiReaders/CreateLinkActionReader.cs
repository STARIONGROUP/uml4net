...
namespace uml4net.xmi.Readers
{
    ...
    public class CreateLinkActionReader : XmiElementReader<ICreateLinkAction>, IXmiElementReader<ICreateLinkAction>
    {
        ...
        /// </returns>
        public override ICreateLinkAction Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "activity":
                                ...
                                break;
                            case "endData":
                                var endDataValue = (ILinkEndCreationData)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:LinkEndCreationData");
