...
namespace uml4net.xmi.Readers
{
    ...
    public class DeviceReader : XmiElementReader<IDevice>, IXmiElementReader<IDevice>
    {
        ...
        /// </param>
        public DeviceReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
