...
namespace uml4net.xmi.Readers
{
    ...
    public class DeviceReader : XmiElementReader<IDevice>, IXmiElementReader<IDevice>
    {
        ...
        /// </returns>
        public override IDevice Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nestedClassifier":
                                ...
                                break;
                            case "nestedNode":
                                var nestedNodeValue = (INode)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Node");
