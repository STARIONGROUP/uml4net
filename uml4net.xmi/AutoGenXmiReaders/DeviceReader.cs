...
namespace uml4net.xmi.Readers
{
    ...
    public class DeviceReader : XmiElementReader<IDevice>, IXmiElementReader<IDevice>
    {
        ...
        /// </param>
        public DeviceReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nestedClassifier":
                                ...
                                break;
                            case "nestedNode":
                                var nestedNodeValue = (INode)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:Node");
                            ...
                            case "visibility":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"DeviceReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
