...
namespace uml4net.xmi.Readers.Deployments
{
    ...
    public class DeviceReader : XmiElementReader<IDevice>, IXmiElementReader<IDevice>
    {
        ...
        /// </param>
        public DeviceReader(IXmiReaderCache cache, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "nestedClassifier":
                                ...
                                break;
                            case "nestedNode":
                                var nestedNode = (INode)this.xmiElementReaderFacade.QueryXmiElement(xmlReader, this.Cache, this.LoggerFactory, "uml:Node");
                                poco.NestedNode.Add(nestedNode);
                                break;
                            case "ownedAttribute":
