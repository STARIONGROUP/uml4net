...
namespace uml4net.xmi.Readers
{
    ...
    public class OperationTemplateParameterReader : XmiElementReader<IOperationTemplateParameter>, IXmiElementReader<IOperationTemplateParameter>
    {
        ...
        /// </param>
        public OperationTemplateParameterReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IOperationTemplateParameter Read(XmlReader xmlReader)
        {
            if (xmlReader == null)
            {
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "signature":
                                ...
                                break;
                            default:
                                throw new NotSupportedException($"OperationTemplateParameterReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                        }
                    }
                }
            }
