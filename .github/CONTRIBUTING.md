...
1. Configure the upstream repo (`git remote add upstream git://github.com/STARIONGROUP/uml4net`) 
...
And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/STARIONGROUP/uml4net/wiki) once it has been pulled in
