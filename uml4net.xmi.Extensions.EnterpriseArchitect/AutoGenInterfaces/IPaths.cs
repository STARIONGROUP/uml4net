// -------------------------------------------------------------------------------------------------
// <copyright file="IPaths.cs" company="Starion Group S.A.">
//
...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure
{
    ...
    public partial interface IPaths : uml4net.CommonStructure.IElement
    {
        /// <summary>
        /// </summary>
        ...
        public IContainerList<IPath> Path { get; set; }
    }
}
