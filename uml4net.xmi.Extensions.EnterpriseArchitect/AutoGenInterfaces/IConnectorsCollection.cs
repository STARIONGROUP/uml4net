// -------------------------------------------------------------------------------------------------
// <copyright file="IConnectorsCollection.cs" company="Starion Group S.A.">
//
...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure
{
    ...
    public partial interface IConnectorsCollection : uml4net.CommonStructure.IElement
    {
        /// <summary>
        /// </summary>
        ...
        public IContainerList<IConnector> Connector { get; set; }
    }
}
