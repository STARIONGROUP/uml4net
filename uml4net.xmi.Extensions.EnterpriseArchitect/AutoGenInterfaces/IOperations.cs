// -------------------------------------------------------------------------------------------------
// <copyright file="IOperations.cs" company="Starion Group S.A.">
//
...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure
{
    ...
    public partial interface IOperations : uml4net.CommonStructure.IElement
    {
        /// <summary>
        /// </summary>
        ...
        public IContainerList<IOperation> Operation { get; set; }
    }
}
