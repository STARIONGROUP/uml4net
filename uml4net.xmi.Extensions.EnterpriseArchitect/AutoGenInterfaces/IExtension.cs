...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure
{
    ...
    public partial interface IExtension : uml4net.Packages.IPackage
    {
        /// <summary>
        /// </summary>
        ...
        public IContainerList<IElementsCollection> Elements { get; set; }
        ...
        public IContainerList<IConnectorsCollection> Connectors { get; set; }
    }
}
