...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class DocumentationReader : ExtensionContentReader<IDocumentation>
    {
        ...
        /// </param>
        public DocumentationReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IDocumentation Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IDocumentation poco = new xmi.Extensions.EnterpriseArchitect.Structure.Documentation();
