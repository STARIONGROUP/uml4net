...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class TemplateBindingReader : ExtensionContentReader<ITemplateBinding>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public TemplateBindingReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ITemplateBinding Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            ITemplateBinding poco = new xmi.Extensions.EnterpriseArchitect.Structure.TemplateBinding();
