...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class ExtendedPropertiesReader : ExtensionContentReader<IExtendedProperties>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public ExtendedPropertiesReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IExtendedProperties Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IExtendedProperties poco = new xmi.Extensions.EnterpriseArchitect.Structure.ExtendedProperties();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var diagramValue = xmlReader.GetAttribute("diagram");
                poco.Diagram = diagramValue;
                var packageNameValue = xmlReader.GetAttribute("packageName");
                poco.PackageName = packageNameValue;
