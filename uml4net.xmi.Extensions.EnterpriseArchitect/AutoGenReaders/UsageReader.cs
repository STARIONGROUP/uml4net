...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class UsageReader : ExtensionContentReader<IUsage>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public UsageReader(IExtenderReaderRegistry registry, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IUsage Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IUsage poco = new xmi.Extensions.EnterpriseArchitect.Structure.Usage();
