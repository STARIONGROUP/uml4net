...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class GeneralizationReader : ExtensionContentReader<IGeneralization>
    {
        ...
        /// </param>
        public GeneralizationReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IGeneralization Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IGeneralization poco = new xmi.Extensions.EnterpriseArchitect.Structure.Generalization();
