...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure.Readers
{
    ...
    public partial class GeneralizationReader : XmiElementReader<IGeneralization>, IXmiElementReader<IGeneralization>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public GeneralizationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
        ...
        public override IGeneralization Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            IGeneralization poco = new xmi.Extensions.EntrepriseArchitect.Structure.Generalization();
