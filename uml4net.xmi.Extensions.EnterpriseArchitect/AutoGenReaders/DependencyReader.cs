...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure.Readers
{
    ...
    public partial class DependencyReader : ExtensionContentReader<IDependency>
    {
        ...
        /// </param>
        public DependencyReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IDependency Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
