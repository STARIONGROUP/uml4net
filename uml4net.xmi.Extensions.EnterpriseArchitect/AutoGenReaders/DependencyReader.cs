...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure.Readers
{
    ...
    public partial class DependencyReader : XmiElementReader<IDependency>, IXmiElementReader<IDependency>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        public override IDependency Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            IDependency poco = new xmi.Extensions.EntrepriseArchitect.Structure.Dependency();
