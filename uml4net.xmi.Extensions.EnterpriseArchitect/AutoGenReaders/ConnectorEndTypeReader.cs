...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class ConnectorEndTypeReader : ExtensionContentReader<IConnectorEndType>
    {
        ...
        /// </param>
        public ConnectorEndTypeReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IConnectorEndType Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IConnectorEndType poco = new xmi.Extensions.EnterpriseArchitect.Structure.ConnectorEndType();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var aggregationValue = xmlReader.GetAttribute("aggregation");
                poco.Aggregation = aggregationValue;
