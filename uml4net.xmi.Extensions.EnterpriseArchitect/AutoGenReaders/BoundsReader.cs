...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class BoundsReader : ExtensionContentReader<IBounds>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public BoundsReader(IExtenderReaderRegistry registry, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        public override IBounds Read(XmlReader xmlReader, string documentName)
        {
            ...
            IBounds poco = new xmi.Extensions.EnterpriseArchitect.Structure.Bounds();
