...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class UseCaseReader : ExtensionContentReader<IUseCase>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public UseCaseReader(IExtenderReaderRegistry registry, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IUseCase Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IUseCase poco = new xmi.Extensions.EnterpriseArchitect.Structure.UseCase();
