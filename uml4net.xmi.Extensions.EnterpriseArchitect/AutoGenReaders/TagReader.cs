...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class TagReader : ExtensionContentReader<ITag>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public TagReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override ITag Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            ITag poco = new xmi.Extensions.EnterpriseArchitect.Structure.Tag();
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                var modelElementValue = xmlReader.GetAttribute("modelElement");
                poco.ModelElement = modelElementValue;
