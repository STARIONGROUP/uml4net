...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure.Readers
{
    ...
    public partial class TypeElementReader : XmiElementReader<ITypeElement>, IXmiElementReader<ITypeElement>
    {
        ...
        /// </param>
        public TypeElementReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
        ...
        public override ITypeElement Read(XmlReader xmlReader, string documentName, string namespaceUri)
        {
            ...
            if (xmlReader.MoveToContent() == XmlNodeType.Element)
            {
                ...
                poco.Concurrency = xmlReader.GetAttribute("concurrency");
                ...
                var isQueryXmlAttribute = xmlReader.GetAttribute("isQuery");
                ...
                var pureXmlAttribute = xmlReader.GetAttribute("pure");
                ...
                var returnarrayXmlAttribute = xmlReader.GetAttribute("returnarray");
                ...
                var synchronisedXmlAttribute = xmlReader.GetAttribute("synchronised");
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName.LowerCaseFirstLetter())
                        {
                            ...
                            default:
                                ...
                                {
                                    throw new NotSupportedException($"TypeElementReader: {xmlReader.LocalName} at line:position {defaultLineInfo.LineNumber}:{defaultLineInfo.LinePosition}");
                                }
                                else
                                {
                                    this.Logger.LogWarning("Not Supported: TypeElementReader: {LocalName} at line:position {LineNumber}:{LinePosition}", xmlReader.LocalName, defaultLineInfo.LineNumber, defaultLineInfo.LinePosition);
                                }
