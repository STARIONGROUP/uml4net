...
namespace uml4net.xmi.Extensions.EnterpriseArchitect.Structure.Readers
{
    ...
    public partial class AssociationReader : ExtensionContentReader<IAssociation>
    {
        /// <summary>
        /// The (injected) logger
        /// </summary>
        ...
        /// </param>
        public AssociationReader(IExtensionContentReaderFacade extensionContentReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, IXmiElementCache cache, ILoggerFactory loggerFactory)
        ...
        /// </returns>
        public override IAssociation Read(XmlReader xmlReader, string documentName)
        {
            if (xmlReader == null)
            {
            ...
            IAssociation poco = new xmi.Extensions.EnterpriseArchitect.Structure.Association();
