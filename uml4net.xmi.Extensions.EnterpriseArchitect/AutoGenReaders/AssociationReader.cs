...
namespace uml4net.xmi.Extensions.EntrepriseArchitect.Structure.Readers
{
    ...
    public partial class AssociationReader : XmiElementReader<IAssociation>, IXmiElementReader<IAssociation>
    {
        ...
        /// </param>
        public AssociationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
