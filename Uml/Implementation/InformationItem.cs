...
namespace Implementation.InformationFlows
{
    ...
    /// </summary>
    internal class InformationItem : Implementation.CommonStructure.Element //, Uml.InformationFlows.InformationItem
    {
        public InformationItem(string id) : base(id)
        {
        }
    }
}