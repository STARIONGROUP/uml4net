// -------------------------------------------------------------------------------------------------
//  <copyright file="HandlebarsPayloadFactory.cs" company="Starion Group S.A.">
// 
...
namespace uml4net.Reporting.Payload
{
    ...
    /// <summary>
    /// The purpose of the <see cref="HandlebarsPayloadFactory"/> class is to create an instance
    /// of <see cref="HandlebarsPayload"/> based on an instance of <see cref="XmiReaderResult"/>
    /// </summary>
    public static class HandlebarsPayloadFactory
    {
        /// <summary>
