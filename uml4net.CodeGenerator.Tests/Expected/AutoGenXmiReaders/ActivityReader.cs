...
namespace uml4net.xmi.Readers
{
    ...
    public class ActivityReader : XmiElementReader<IActivity>, IXmiElementReader<IActivity>
    {
        ...
        /// </param>
        public ActivityReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            ...
                            case "generalization":
                                ...
                                break;
                            case "group":
                                var groupValue = (IActivityGroup)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.XmiReaderSettings, this.LoggerFactory);
