...
namespace uml4net.xmi.Readers
{
    ...
    public class ExpressionReader : XmiElementReader<IExpression>, IXmiElementReader<IExpression>
    {
        ...
        /// </param>
        public ExpressionReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
