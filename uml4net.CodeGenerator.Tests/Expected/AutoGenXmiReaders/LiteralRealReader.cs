...
namespace uml4net.xmi.Readers
{
    ...
    public class LiteralRealReader : XmiElementReader<ILiteralReal>, IXmiElementReader<ILiteralReal>
    {
        ...
        /// </param>
        public LiteralRealReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
