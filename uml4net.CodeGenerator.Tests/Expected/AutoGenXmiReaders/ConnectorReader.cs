...
namespace uml4net.xmi.Readers
{
    ...
    public class ConnectorReader : XmiElementReader<IConnector>, IXmiElementReader<IConnector>
    {
        ...
        /// </param>
        public ConnectorReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, ILoggerFactory loggerFactory)
                    ...
                    if (xmlReader.NodeType == XmlNodeType.Element)
                    {
                        switch (xmlReader.LocalName)
                        {
                            case "contract":
                                ...
                                break;
                            case "end":
                                var endValue = (IConnectorEnd)this.XmiElementReaderFacade.QueryXmiElement(xmlReader, documentName, namespaceUri, this.Cache, this.LoggerFactory, "uml:ConnectorEnd");
