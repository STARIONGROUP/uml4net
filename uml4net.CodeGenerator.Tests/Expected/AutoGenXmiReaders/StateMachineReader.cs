...
namespace uml4net.xmi.Readers
{
    ...
    public class StateMachineReader : XmiElementReader<IStateMachine>, IXmiElementReader<IStateMachine>
    {
        ...
        /// </param>
        public StateMachineReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, ILoggerFactory loggerFactory)
