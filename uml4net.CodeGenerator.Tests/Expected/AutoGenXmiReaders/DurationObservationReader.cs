...
namespace uml4net.xmi.Readers
{
    ...
    public class DurationObservationReader : XmiElementReader<IDurationObservation>, IXmiElementReader<IDurationObservation>
    {
        ...
        /// </param>
        public DurationObservationReader(IXmiElementCache cache, IXmiElementReaderFacade xmiElementReaderFacade, IXmiReaderSettings xmiReaderSettings, INameSpaceResolver nameSpaceResolver, ILoggerFactory loggerFactory)
