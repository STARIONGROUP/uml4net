// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralInteger.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class LiteralInteger : XmiElement, ILiteralInteger
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ILiteralInteger);
        ...
        /// </summary>
        [Property(xmiId: "LiteralInteger-value", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: "0")]
