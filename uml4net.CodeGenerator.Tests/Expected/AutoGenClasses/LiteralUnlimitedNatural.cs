// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralUnlimitedNatural.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class LiteralUnlimitedNatural : XmiElement, ILiteralUnlimitedNatural
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ILiteralUnlimitedNatural);
