...
namespace uml4net.Interactions
{
    ...
    /// </summary>
    [Class(xmiId: "ExecutionSpecification", isAbstract: true, isFinalSpecialization: false, isActive: false)]
    public partial interface IExecutionSpecification : IInteractionFragment
    {
        /// <summary>
