...
namespace uml4net.CommonStructure
{
    ...
    /// </summary>
    [Class(xmiId: "DirectedRelationship", isAbstract: true, isFinalSpecialization: false, isActive: false)]
    public partial interface IDirectedRelationship : IRelationship
    {
        /// <summary>
