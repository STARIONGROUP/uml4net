...
namespace uml4net.Classification
{
    ...
    /// the Classifier.
    /// </summary>
    [Class(xmiId: "StructuralFeature", isAbstract: true, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial interface IStructuralFeature : IMultiplicityElement, ITypedElement, IFeature
    {
        /// <summary>
