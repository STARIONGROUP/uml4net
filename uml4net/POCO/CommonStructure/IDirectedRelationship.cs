// -------------------------------------------------------------------------------------------------
// <copyright file="IDirectedRelationship.cs" company="Starion Group S.A.">
//
...
namespace uml4net.POCO.CommonStructure
{
    ...
    /// <summary>
    /// A DirectedRelationship represents a relationship between a collection of source model Elements
    /// and a collection of target model Elements.
    /// </summary>
    public interface IDirectedRelationship : IRelationship
    {
        /// <summary>
