...
namespace uml4net.POCO.CommonStructure
{
    ...
    /// <summary>
    /// A TemplateParameterSubstitution relates the actual parameter to a formal TemplateParameter as part of
    /// a template binding.
    /// </summary>
    public class TemplateParameterSubstitution : XmiElement, ITemplateParameterSubstitution
    {
        /// <summary>
