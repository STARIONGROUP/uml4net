// -------------------------------------------------------------------------------------------------
// <copyright file="MessageOccurrenceSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.POCO.Interactions
{
    ...
    /// <summary>
    /// A MessageOccurrenceSpecification specifies the occurrence of Message events, such as sending
    /// and receiving of Signals or invoking or receiving of Operation calls. A MessageOccurrenceSpecification
    /// is a kind of MessageEnd. Messages are generated either by synchronous Operation calls or asynchronous
    /// Signal sends. They are received by the execution of corresponding AcceptEventActions.
    /// </summary>
    public class MessageOccurrenceSpecification : XmiElement, IMessageOccurrenceSpecification
    {
        /// <summary>
