// -------------------------------------------------------------------------------------------------
// <copyright file="SendObjectAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.POCO.Actions
{
    ...
    /// <summary>
    /// A SendObjectAction is an InvocationAction that transmits an input object to the target object, 
    /// which is handled as a request message by the target object. The requestor continues execution 
    /// immediately after the object is sent out and cannot receive reply values.
    /// </summary>
    public class SendObjectAction : XmiElement, ISendObjectAction
    {
        /// <summary>
