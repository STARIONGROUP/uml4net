...
namespace uml4net.POCO.Actions
{
    ...
    /// <summary>
    /// A ClearAssociationAction is an Action that destroys all links of an Association in which 
    /// a particular object participates.
    /// </summary>
    public class ClearAssociationAction : XmiElement, IClearAssociationAction
    {
        /// <summary>
