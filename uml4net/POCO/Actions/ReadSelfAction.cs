...
namespace uml4net.POCO.Actions
{
    ...
    /// <summary>
    /// A ReadSelfAction is an Action that retrieves the context object of the Behavior execution
    /// within which the ReadSelfAction execution is taking place.
    /// </summary>
    public class ReadSelfAction : XmiElement, IReadSelfAction
    {
        /// <summary>
