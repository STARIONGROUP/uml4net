...
namespace uml4net.POCO.Actions
{
    ...
    /// <summary>
    /// A RemoveStructuralFeatureValueAction is a WriteStructuralFeatureAction that removes values
    /// from a StructuralFeature.
    /// </summary>
    public class RemoveStructuralFeatureValueAction : XmiElement, IRemoveStructuralFeatureValueAction
    {
        /// <summary>
