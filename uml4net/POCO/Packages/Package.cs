...
namespace uml4net.POCO.Packages
{
    ...
    public class Package : IPackage
    {
        ...
        [SubsettedProperty(propertyName: "A_source_directedRelationship.directedRelationship")]
        [SubsettedProperty(propertyName: "Element.OwnedElement")]
        List<ElementImport> INamespace.ElementImport { get; set; } = new List<ElementImport>();
        ...
        List<IConstraint> INamespace.OwnedRule { get; set; } = new List<IConstraint>();
        ...
        [Property(aggregation: AggregationKind.Composite, lowerValue: 0, upperValue: int.MaxValue)]
        [SubsettedProperty(propertyName: "Element.OwnedElement")]
        List<IPackageImport> INamespace.PackageImport { get; set; } = new List<IPackageImport>();
