// -------------------------------------------------------------------------------------------------
// <copyright file="ConditionalNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ConditionalNode : XmiElement, IConditionalNode
    {
        /// <summary>
        ...
        [Implements(implementation: "IConditionalNode.Clause")]
        public IContainerList<IClause> Clause
        {
            get => this.clause ??= new ContainerList<IClause>(this);
            set => this.clause = value;
        }

        /// <summary>
        /// Backing field for <see cref="Clause"/>
        /// </summary>
        private IContainerList<IClause> clause;
        ...
        [Implements(implementation: "IConditionalNode.IsAssured")]
        ...
        [Implements(implementation: "IConditionalNode.IsDeterminate")]
