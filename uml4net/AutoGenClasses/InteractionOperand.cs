...
namespace uml4net.Interactions
{
    ...
    public partial class InteractionOperand : XmiElement, IInteractionOperand
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IInteractionOperand);
        ...
        public IContainerList<IInteractionFragment> Fragment
        {
            get => this.fragment ??= new ContainerList<IInteractionFragment>(this,
                containedElement => { containedElement.EnclosingOperand = this; },
                containedElement => { if (ReferenceEquals(containedElement.EnclosingOperand, this)) { containedElement.EnclosingOperand = null; } });
