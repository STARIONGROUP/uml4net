// -------------------------------------------------------------------------------------------------
// <copyright file="ParameterSet.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Classification
{
    ...
    public partial class ParameterSet : XmiElement, IParameterSet
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IParameterSet);
        ...
        /// </summary>
        private IContainerList<IConstraint> condition;
        ...
        public List<IParameter> Parameter { get; set; } = new();
