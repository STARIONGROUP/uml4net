// -------------------------------------------------------------------------------------------------
// <copyright file="CentralBufferNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    public partial class CentralBufferNode : XmiElement, ICentralBufferNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ICentralBufferNode);
