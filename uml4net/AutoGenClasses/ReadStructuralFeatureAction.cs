// -------------------------------------------------------------------------------------------------
// <copyright file="ReadStructuralFeatureAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A ReadStructuralFeatureAction is a StructuralFeatureAction that retrieves the values of a
    /// StructuralFeature.
    /// </summary>
    [Class(xmiId: "ReadStructuralFeatureAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ReadStructuralFeatureAction : XmiElement, IReadStructuralFeatureAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadStructuralFeatureAction);
        ...
        /// </summary>
        [Property(xmiId: "ReadStructuralFeatureAction-result", aggregation: AggregationKind.Composite, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Action-output")]
        [Implements(implementation: "IReadStructuralFeatureAction.Result")]
        ...
        [Implements(implementation: "IStructuralFeatureAction.StructuralFeature")]
