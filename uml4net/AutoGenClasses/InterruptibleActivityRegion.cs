...
namespace uml4net.POCO.Activities
{
    ...
    /// <summary>
    /// An InterruptibleActivityRegion is an ActivityGroup that supports 
    /// the termination of tokens flowing in the portions of an activity within it.
    /// </summary>
    public class InterruptibleActivityRegion : XmiElement, IInterruptibleActivityRegion
    {
        /// <summary>
