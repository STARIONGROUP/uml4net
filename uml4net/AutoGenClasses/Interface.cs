...
namespace uml4net.SimpleClassifiers
{
    ...
    public partial class Interface : XmiElement, IInterface
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IInterface);
        ...
        public IContainerList<IProperty> OwnedAttribute
        {
            get => this.ownedAttribute ??= new ContainerList<IProperty>(this,
                containedElement => { containedElement.Interface = this; },
                containedElement => { if (ReferenceEquals(containedElement.Interface, this)) { containedElement.Interface = null; } });
