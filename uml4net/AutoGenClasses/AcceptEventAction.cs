// -------------------------------------------------------------------------------------------------
// <copyright file="AcceptEventAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class AcceptEventAction : XmiElement, IAcceptEventAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IAcceptEventAction);
