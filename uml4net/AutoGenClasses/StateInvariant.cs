// -------------------------------------------------------------------------------------------------
// <copyright file="StateInvariant.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    /// internal or external States, and so on. A StateInvariant is an InteractionFragment and it is placed
    /// on a Lifeline.
    /// </summary>
    [Class(xmiId: "StateInvariant", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class StateInvariant : XmiElement, IStateInvariant
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IStateInvariant);
        ...
        /// <summary>
        /// Backing field for <see cref="Invariant"/>
        /// </summary>
        private IContainerList<IConstraint> invariant;
