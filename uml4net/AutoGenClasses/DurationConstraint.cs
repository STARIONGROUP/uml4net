// -------------------------------------------------------------------------------------------------
// <copyright file="DurationConstraint.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class DurationConstraint : XmiElement, IDurationConstraint
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDurationConstraint);
        ...
        /// </summary>
        private IContainerList<IDurationInterval> specification;
