// -------------------------------------------------------------------------------------------------
// <copyright file="Lifeline.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    public partial class Lifeline : XmiElement, ILifeline
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ILifeline);
        ...
        /// <summary>
        /// Backing field for <see cref="Selector"/>
        /// </summary>
        private IContainerList<IValueSpecification> selector;
