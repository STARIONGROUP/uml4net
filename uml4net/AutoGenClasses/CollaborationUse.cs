// -------------------------------------------------------------------------------------------------
// <copyright file="CollaborationUse.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StructuredClassifiers
{
    ...
    public partial class CollaborationUse : XmiElement, ICollaborationUse
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ICollaborationUse);
        ...
        {
            get => this.roleBinding ??= new ContainerList<IDependency>(this);
            set => this.roleBinding = value;
        }

        /// <summary>
        /// Backing field for <see cref="RoleBinding"/>
        /// </summary>
        private IContainerList<IDependency> roleBinding;
