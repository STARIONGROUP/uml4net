// -------------------------------------------------------------------------------------------------
// <copyright file="ClearVariableAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// </summary>
    [Class(xmiId: "ClearVariableAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ClearVariableAction : XmiElement, IClearVariableAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IClearVariableAction);
