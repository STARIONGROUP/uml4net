// -------------------------------------------------------------------------------------------------
// <copyright file="Include.cs" company="Starion Group S.A.">
//
...
namespace uml4net.UseCases
{
    ...
    public partial class Include : XmiElement, IInclude
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IInclude);
        ...
        [Implements(implementation: "IInclude.Addition")]
