...
namespace uml4net.Packages
{
    ...
    public partial class Extension : XmiElement, IExtension
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExtension);
        ...
        public bool IsRequired => this.QueryIsRequired();
        ...
        public IClass Metaclass => this.QueryMetaclass();
        ...
        /// </summary>
        private IContainerList<IExtensionEnd> ownedEnd;
        ...
        [RedefinedByProperty("IExtension.OwnedEnd")]
        [Implements(implementation: "IAssociation.OwnedEnd")]
        IContainerList<IProperty> IAssociation.OwnedEnd
        {
            get => throw new InvalidOperationException("Redefined by property IExtension.OwnedEnd");
            set => throw new InvalidOperationException("Redefined by property IExtension.OwnedEnd");
        }
