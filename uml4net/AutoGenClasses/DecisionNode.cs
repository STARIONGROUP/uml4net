// -------------------------------------------------------------------------------------------------
// <copyright file="DecisionNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    /// <summary>
    /// A DecisionNode is a ControlNode that chooses between outgoing ActivityEdges for the routing of
    /// tokens.
    /// </summary>
    [Class(xmiId: "DecisionNode", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class DecisionNode : XmiElement, IDecisionNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDecisionNode);
        ...
        [Implements(implementation: "IDecisionNode.DecisionInput")]
        ...
        [Implements(implementation: "IDecisionNode.DecisionInputFlow")]
