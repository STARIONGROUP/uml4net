// -------------------------------------------------------------------------------------------------
// <copyright file="ReplyAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ReplyAction : XmiElement, IReplyAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReplyAction);
        ...
        .Concat(this.ReplyValue)
        .Concat(this.ReturnInformation)
        .Distinct()
        .ToList();
        ...
        [Implements(implementation: "IReplyAction.ReplyToCall")]
        ...
        [Implements(implementation: "IReplyAction.ReplyValue")]
        public IContainerList<IInputPin> ReplyValue
        {
            get => this.replyValue ??= new ContainerList<IInputPin>(this);
            set => this.replyValue = value;
        }

        /// <summary>
        /// Backing field for <see cref="ReplyValue"/>
        /// </summary>
        private IContainerList<IInputPin> replyValue;
        ...
        /// <summary>
        /// Backing field for <see cref="ReturnInformation"/>
        /// </summary>
        private IContainerList<IInputPin> returnInformation;
