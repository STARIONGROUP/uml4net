// -------------------------------------------------------------------------------------------------
// <copyright file="Collaboration.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StructuredClassifiers
{
    ...
    public partial class Collaboration : XmiElement, ICollaboration
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ICollaboration);
        ...
        [Implements(implementation: "ICollaboration.CollaborationRole")]
        public List<IConnectableElement> CollaborationRole { get; set; } = new();
