// -------------------------------------------------------------------------------------------------
// <copyright file="ReadLinkAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A ReadLinkAction is a LinkAction that navigates across an Association to retrieve the objects on one
    /// end.
    /// </summary>
    [Class(xmiId: "ReadLinkAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ReadLinkAction : XmiElement, IReadLinkAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadLinkAction);
        ...
        public IContainerList<ILinkEndData> EndData
        {
            get => this.endData ??= new ContainerList<ILinkEndData>(this);
            set => this.endData = value;
        }

        /// <summary>
        /// Backing field for <see cref="EndData"/>
        /// </summary>
        private IContainerList<ILinkEndData> endData;
        ...
        [Implements(implementation: "ILinkAction.InputValue")]
        public IContainerList<IInputPin> InputValue
        {
            get => this.inputValue ??= new ContainerList<IInputPin>(this);
            set => this.inputValue = value;
        }

        /// <summary>
        /// Backing field for <see cref="InputValue"/>
        /// </summary>
        private IContainerList<IInputPin> inputValue;
        ...
        /// </summary>
        [Property(xmiId: "ReadLinkAction-result", aggregation: AggregationKind.Composite, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
