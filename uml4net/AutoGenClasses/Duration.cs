// -------------------------------------------------------------------------------------------------
// <copyright file="Duration.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    /// </summary>
    [Class(xmiId: "Duration", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class Duration : XmiElement, IDuration
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDuration);
        ...
        [Implements(implementation: "IDuration.Expr")]
        ...
        [Implements(implementation: "IDuration.Observation")]
