// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectableElementTemplateParameter.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StructuredClassifiers
{
    ...
    /// <summary>
    /// A ConnectableElementTemplateParameter exposes a ConnectableElement as a formal parameter for a
    /// template.
    /// </summary>
    [Class(xmiId: "ConnectableElementTemplateParameter", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ConnectableElementTemplateParameter : XmiElement, IConnectableElementTemplateParameter
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IConnectableElementTemplateParameter);
