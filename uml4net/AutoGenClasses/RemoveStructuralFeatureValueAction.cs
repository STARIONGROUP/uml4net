// -------------------------------------------------------------------------------------------------
// <copyright file="RemoveStructuralFeatureValueAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class RemoveStructuralFeatureValueAction : XmiElement, IRemoveStructuralFeatureValueAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IRemoveStructuralFeatureValueAction);
        ...
        [Implements(implementation: "IRemoveStructuralFeatureValueAction.IsRemoveDuplicates")]
        ...
        [SubsettedProperty(propertyName: "Action-input")]
        [Implements(implementation: "IRemoveStructuralFeatureValueAction.RemoveAt")]
        ...
        /// <summary>
        /// Backing field for <see cref="RemoveAt"/>
        /// </summary>
        private IContainerList<IInputPin> removeAt;
