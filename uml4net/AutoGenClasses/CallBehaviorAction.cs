// -------------------------------------------------------------------------------------------------
// <copyright file="CallBehaviorAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class CallBehaviorAction : XmiElement, ICallBehaviorAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ICallBehaviorAction);
        ...
        [Implements(implementation: "ICallBehaviorAction.Behavior")]
