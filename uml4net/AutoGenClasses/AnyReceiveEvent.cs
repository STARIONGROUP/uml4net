// -------------------------------------------------------------------------------------------------
// <copyright file="AnyReceiveEvent.cs" company="Starion Group S.A.">
//
...
namespace uml4net.CommonBehavior
{
    ...
    /// <summary>
    /// A trigger for an AnyReceiveEvent is triggered by the receipt of any message that is not explicitly
    /// handled by any related trigger.
    /// </summary>
    [Class(xmiId: "AnyReceiveEvent", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class AnyReceiveEvent : XmiElement, IAnyReceiveEvent
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IAnyReceiveEvent);
