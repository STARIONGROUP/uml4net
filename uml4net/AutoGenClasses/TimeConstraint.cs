// -------------------------------------------------------------------------------------------------
// <copyright file="TimeConstraint.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class TimeConstraint : XmiElement, ITimeConstraint
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ITimeConstraint);
        ...
        /// </summary>
        private IContainerList<ITimeInterval> specification;
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ITimeConstraint.Specification");
            set => throw new InvalidOperationException("Redefined by property ITimeConstraint.Specification");
        }
