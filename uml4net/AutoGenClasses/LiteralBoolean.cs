// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralBoolean.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    /// </summary>
    [Class(xmiId: "LiteralBoolean", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    public partial class LiteralBoolean : XmiElement, ILiteralBoolean
    {
        /// <summary>
        ...
        /// </summary>
        [Property(xmiId: "LiteralBoolean-value", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: false, defaultValue: "false")]
