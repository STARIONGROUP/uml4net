// -------------------------------------------------------------------------------------------------
// <copyright file="ActivityFinalNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    public partial class ActivityFinalNode : XmiElement, IActivityFinalNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IActivityFinalNode);
