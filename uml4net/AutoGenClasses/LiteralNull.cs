// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralNull.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    /// </summary>
    [Class(xmiId: "LiteralNull", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class LiteralNull : XmiElement, ILiteralNull
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ILiteralNull);
