// -------------------------------------------------------------------------------------------------
// <copyright file="InformationItem.cs" company="Starion Group S.A.">
//
...
namespace uml4net.InformationFlows
{
    ...
    public partial class InformationItem : XmiElement, IInformationItem
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IInformationItem);
        ...
        [Implements(implementation: "IInformationItem.Represented")]
        public List<IClassifier> Represented { get; set; } = new();
