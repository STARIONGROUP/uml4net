// -------------------------------------------------------------------------------------------------
// <copyright file="ValuePin.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// </summary>
    [Class(xmiId: "ValuePin", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ValuePin : XmiElement, IValuePin
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IValuePin);
        ...
        [SubsettedProperty(propertyName: "Element-ownedElement")]
        [Implements(implementation: "IValuePin.Value")]
