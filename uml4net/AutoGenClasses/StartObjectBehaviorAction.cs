// -------------------------------------------------------------------------------------------------
// <copyright file="StartObjectBehaviorAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// the input Parameters of the Behavior. If the Behavior is invoked synchronously, then output values
    /// may be obtained for output Parameters.
    /// </summary>
    [Class(xmiId: "StartObjectBehaviorAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class StartObjectBehaviorAction : XmiElement, IStartObjectBehaviorAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IStartObjectBehaviorAction);
