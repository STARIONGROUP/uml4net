// -------------------------------------------------------------------------------------------------
// <copyright file="ExtensionPoint.cs" company="Starion Group S.A.">
//
...
namespace uml4net.UseCases
{
    ...
    public partial class ExtensionPoint : XmiElement, IExtensionPoint
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExtensionPoint);
        ...
        [Implements(implementation: "IExtensionPoint.UseCase")]
