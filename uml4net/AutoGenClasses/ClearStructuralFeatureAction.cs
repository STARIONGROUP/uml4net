// -------------------------------------------------------------------------------------------------
// <copyright file="ClearStructuralFeatureAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A ClearStructuralFeatureAction is a StructuralFeatureAction that removes all values of a
    /// StructuralFeature.
    /// </summary>
    [Class(xmiId: "ClearStructuralFeatureAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ClearStructuralFeatureAction : XmiElement, IClearStructuralFeatureAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IClearStructuralFeatureAction);
        ...
        [Implements(implementation: "IClearStructuralFeatureAction.Result")]
