// -------------------------------------------------------------------------------------------------
// <copyright file="AddStructuralFeatureValueAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// StructuralFeature.
    /// </summary>
    [Class(xmiId: "AddStructuralFeatureValueAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class AddStructuralFeatureValueAction : XmiElement, IAddStructuralFeatureValueAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IAddStructuralFeatureValueAction);
        ...
        /// <summary>
        /// The InputPin that gives the position at which to insert the value in an ordered StructuralFeature.
        ...
        /// <summary>
        /// Backing field for <see cref="InsertAt"/>
        /// </summary>
        private IContainerList<IInputPin> insertAt;
        ...
        [Implements(implementation: "IAddStructuralFeatureValueAction.IsReplaceAll")]
        ...
        /// </summary>
        private IContainerList<IInputPin> value;
