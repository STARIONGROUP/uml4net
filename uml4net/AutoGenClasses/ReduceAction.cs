// -------------------------------------------------------------------------------------------------
// <copyright file="ReduceAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ReduceAction : XmiElement, IReduceAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReduceAction);
        ...
        /// <summary>
        /// Backing field for <see cref="Collection"/>
        /// </summary>
        private IContainerList<IInputPin> collection;
        ...
        [Implements(implementation: "IReduceAction.IsOrdered")]
        ...
        [Implements(implementation: "IReduceAction.Reducer")]
