...
namespace uml4net.CommonBehavior
{
    ...
    public partial class FunctionBehavior : XmiElement, IFunctionBehavior
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IFunctionBehavior);
        ...
        [Implements(implementation: "IOpaqueBehavior.Body")]
