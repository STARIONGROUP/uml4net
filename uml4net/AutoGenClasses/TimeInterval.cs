// -------------------------------------------------------------------------------------------------
// <copyright file="TimeInterval.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    /// </summary>
    [Class(xmiId: "TimeInterval", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class TimeInterval : XmiElement, ITimeInterval
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ITimeInterval);
        ...
        [Implements(implementation: "ITimeInterval.Max")]
        public ITimeExpression Max { get; set; }
        ...
        [RedefinedByProperty("ITimeInterval.Max")]
        ...
        [Implements(implementation: "ITimeInterval.Min")]
        public ITimeExpression Min { get; set; }
        ...
        [RedefinedByProperty("ITimeInterval.Min")]
