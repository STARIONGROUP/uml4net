// -------------------------------------------------------------------------------------------------
// <copyright file="Component.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StructuredClassifiers
{
    ...
    public partial class Component : XmiElement, IComponent
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IComponent);
        ...
        .Concat(this.PackagedElement)
        .Concat(this.PackageImport)
        .Concat(this.Realization)
        ...
        public IContainerList<IComponentRealization> Realization
        {
            get => this.realization ??= new ContainerList<IComponentRealization>(this,
                containedElement => { containedElement.Abstraction = this; },
                containedElement => { if (ReferenceEquals(containedElement.Abstraction, this)) { containedElement.Abstraction = null; } });
            set => this.realization = value;
        }

        /// <summary>
        /// Backing field for <see cref="Realization"/>
        /// </summary>
        private IContainerList<IComponentRealization> realization;
