// -------------------------------------------------------------------------------------------------
// <copyright file="DurationInterval.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class DurationInterval : XmiElement, IDurationInterval
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDurationInterval);
