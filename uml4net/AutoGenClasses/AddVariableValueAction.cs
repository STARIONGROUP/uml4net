// -------------------------------------------------------------------------------------------------
// <copyright file="AddVariableValueAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class AddVariableValueAction : XmiElement, IAddVariableValueAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IAddVariableValueAction);
        ...
        [Implements(implementation: "IAddVariableValueAction.IsReplaceAll")]
