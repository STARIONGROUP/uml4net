// -------------------------------------------------------------------------------------------------
// <copyright file="BroadcastSignalAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class BroadcastSignalAction : XmiElement, IBroadcastSignalAction
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IBroadcastSignalAction);
        ...
        [Implements(implementation: "IBroadcastSignalAction.Signal")]
