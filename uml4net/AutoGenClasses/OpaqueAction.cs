// -------------------------------------------------------------------------------------------------
// <copyright file="OpaqueAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// </summary>
    [Class(xmiId: "OpaqueAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class OpaqueAction : XmiElement, IOpaqueAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IOpaqueAction);
        ...
        [Implements(implementation: "IOpaqueAction.Body")]
        ...
        [Implements(implementation: "IOpaqueAction.InputValue")]
        ...
        [Implements(implementation: "IOpaqueAction.Language")]
        ...
        [Implements(implementation: "IOpaqueAction.OutputValue")]
        public IContainerList<IOutputPin> OutputValue
        {
            get => this.outputValue ??= new ContainerList<IOutputPin>(this);
            set => this.outputValue = value;
        }

        /// <summary>
        /// Backing field for <see cref="OutputValue"/>
        /// </summary>
        private IContainerList<IOutputPin> outputValue;
