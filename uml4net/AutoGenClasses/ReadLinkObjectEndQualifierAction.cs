// -------------------------------------------------------------------------------------------------
// <copyright file="ReadLinkObjectEndQualifierAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ReadLinkObjectEndQualifierAction : XmiElement, IReadLinkObjectEndQualifierAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadLinkObjectEndQualifierAction);
        ...
        [Implements(implementation: "IReadLinkObjectEndQualifierAction.Qualifier")]
