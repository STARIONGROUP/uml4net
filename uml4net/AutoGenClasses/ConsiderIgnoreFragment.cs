// -------------------------------------------------------------------------------------------------
// <copyright file="ConsiderIgnoreFragment.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    /// </summary>
    [Class(xmiId: "ConsiderIgnoreFragment", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ConsiderIgnoreFragment : XmiElement, IConsiderIgnoreFragment
    {
        /// <summary>
        ...
        [Implements(implementation: "ICombinedFragment.CfragmentGate")]
        public IContainerList<IGate> CfragmentGate
        {
            get => this.cfragmentGate ??= new ContainerList<IGate>(this);
            set => this.cfragmentGate = value;
        }

        /// <summary>
        /// Backing field for <see cref="CfragmentGate"/>
        /// </summary>
        private IContainerList<IGate> cfragmentGate;
        ...
        [Implements(implementation: "IConsiderIgnoreFragment.Message")]
        public List<INamedElement> Message { get; set; } = new();
        ...
        [SubsettedProperty(propertyName: "Element-ownedElement")]
        [Implements(implementation: "ICombinedFragment.Operand")]
        public IContainerList<IInteractionOperand> Operand
        {
            get => this.operand ??= new ContainerList<IInteractionOperand>(this);
        ...
        /// </summary>
        private IContainerList<IInteractionOperand> operand;
