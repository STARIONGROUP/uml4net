// -------------------------------------------------------------------------------------------------
// <copyright file="CreateLinkObjectAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A CreateLinkObjectAction is a CreateLinkAction for creating link objects (AssociationClasse
    /// instances).
    /// </summary>
    [Class(xmiId: "CreateLinkObjectAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class CreateLinkObjectAction : XmiElement, ICreateLinkObjectAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ICreateLinkObjectAction);
        ...
        /// </summary>
        private IContainerList<ILinkEndCreationData> endData;
        ...
        [Implements(implementation: "ICreateLinkObjectAction.Result")]
