// -------------------------------------------------------------------------------------------------
// <copyright file="ReadSelfAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A ReadSelfAction is an Action that retrieves the context object of the Behavior execution within
    /// which the ReadSelfAction execution is taking place.
    /// </summary>
    [Class(xmiId: "ReadSelfAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ReadSelfAction : XmiElement, IReadSelfAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadSelfAction);
        ...
        /// </summary>
        [Property(xmiId: "ReadSelfAction-result", aggregation: AggregationKind.Composite, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Action-output")]
        [Implements(implementation: "IReadSelfAction.Result")]
