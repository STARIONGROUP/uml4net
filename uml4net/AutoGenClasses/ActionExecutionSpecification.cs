// -------------------------------------------------------------------------------------------------
// <copyright file="ActionExecutionSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    /// <summary>
    /// An ActionExecutionSpecification is a kind of ExecutionSpecification representing the execution of an
    /// Action.
    /// </summary>
    [Class(xmiId: "ActionExecutionSpecification", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ActionExecutionSpecification : XmiElement, IActionExecutionSpecification
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IActionExecutionSpecification);
        ...
        [Implements(implementation: "IActionExecutionSpecification.Action")]
        ...
        [Implements(implementation: "IExecutionSpecification.Finish")]
        ...
        [Implements(implementation: "IExecutionSpecification.Start")]
