// -------------------------------------------------------------------------------------------------
// <copyright file="ReclassifyObjectAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ReclassifyObjectAction : XmiElement, IReclassifyObjectAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReclassifyObjectAction);
        ...
        [Implements(implementation: "IReclassifyObjectAction.IsReplaceAll")]
        ...
        [Implements(implementation: "IReclassifyObjectAction.NewClassifier")]
        public List<IClassifier> NewClassifier { get; set; } = new();
        ...
        [Implements(implementation: "IReclassifyObjectAction.Object")]
        ...
        [Implements(implementation: "IReclassifyObjectAction.OldClassifier")]
        public List<IClassifier> OldClassifier { get; set; } = new();
