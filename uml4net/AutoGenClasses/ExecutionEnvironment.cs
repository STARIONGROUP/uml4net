// -------------------------------------------------------------------------------------------------
// <copyright file="ExecutionEnvironment.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Deployments
{
    ...
    public partial class ExecutionEnvironment : XmiElement, IExecutionEnvironment
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExecutionEnvironment);
        ...
        [SubsettedProperty(propertyName: "Namespace-ownedMember")]
        [Implements(implementation: "INode.NestedNode")]
        public IContainerList<INode> NestedNode
        {
            get => this.nestedNode ??= new ContainerList<INode>(this);
            set => this.nestedNode = value;
        }

        /// <summary>
        /// Backing field for <see cref="NestedNode"/>
        /// </summary>
        private IContainerList<INode> nestedNode;
