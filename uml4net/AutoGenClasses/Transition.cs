// -------------------------------------------------------------------------------------------------
// <copyright file="Transition.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StateMachines
{
    ...
    public partial class Transition : XmiElement, ITransition
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ITransition);
