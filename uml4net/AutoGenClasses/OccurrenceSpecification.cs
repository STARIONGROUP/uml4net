// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    public partial class OccurrenceSpecification : XmiElement, IOccurrenceSpecification
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IOccurrenceSpecification);
