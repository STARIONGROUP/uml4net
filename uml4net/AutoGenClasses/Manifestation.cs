...
namespace uml4net.Deployments
{
    ...
    public partial class Manifestation : XmiElement, IManifestation
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IManifestation);
        ...
        [Implements(implementation: "IManifestation.UtilizedElement")]
