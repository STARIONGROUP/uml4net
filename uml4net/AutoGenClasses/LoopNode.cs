// -------------------------------------------------------------------------------------------------
// <copyright file="LoopNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class LoopNode : XmiElement, ILoopNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ILoopNode);
        ...
        [Implements(implementation: "ILoopNode.BodyOutput")]
        ...
        [Implements(implementation: "ILoopNode.BodyPart")]
        public List<IExecutableNode> BodyPart { get; set; } = new();
        ...
        [Implements(implementation: "ILoopNode.Decider")]
        ...
        [Implements(implementation: "ILoopNode.IsTestedFirst")]
        ...
        [SubsettedProperty(propertyName: "Element-ownedElement")]
        [Implements(implementation: "ILoopNode.LoopVariable")]
        public IContainerList<IOutputPin> LoopVariable
        {
            get => this.loopVariable ??= new ContainerList<IOutputPin>(this);
            set => this.loopVariable = value;
        }

        /// <summary>
        /// Backing field for <see cref="LoopVariable"/>
        /// </summary>
        private IContainerList<IOutputPin> loopVariable;
        ...
        /// <summary>
        /// Backing field for <see cref="LoopVariableInput"/>
        /// </summary>
        private IContainerList<IInputPin> loopVariableInput;
        ...
        .Concat(this.LoopVariable)
        .Concat(this.LoopVariableInput)
        ...
        [Implements(implementation: "ILoopNode.SetupPart")]
        public List<IExecutableNode> SetupPart { get; set; } = new();
        ...
        [Implements(implementation: "ILoopNode.Test")]
