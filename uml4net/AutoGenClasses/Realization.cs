// -------------------------------------------------------------------------------------------------
// <copyright file="Realization.cs" company="Starion Group S.A.">
//
...
namespace uml4net.CommonStructure
{
    ...
    /// (the client). Realization can be used to model stepwise refinement, optimizations, transformations,
    /// templates, model synthesis, framework composition, etc.
    /// </summary>
    [Class(xmiId: "Realization", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class Realization : XmiElement, IRealization
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IRealization);
