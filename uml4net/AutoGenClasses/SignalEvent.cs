// -------------------------------------------------------------------------------------------------
// <copyright file="SignalEvent.cs" company="Starion Group S.A.">
//
...
namespace uml4net.CommonBehavior
{
    ...
    public partial class SignalEvent : XmiElement, ISignalEvent
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ISignalEvent);
        ...
        [Implements(implementation: "ISignalEvent.Signal")]
