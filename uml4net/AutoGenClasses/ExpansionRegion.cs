// -------------------------------------------------------------------------------------------------
// <copyright file="ExpansionRegion.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ExpansionRegion : XmiElement, IExpansionRegion
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExpansionRegion);
        ...
        [Implements(implementation: "IExpansionRegion.InputElement")]
        public List<IExpansionNode> InputElement { get; set; } = new();
        ...
        [Implements(implementation: "IExpansionRegion.OutputElement")]
        public List<IExpansionNode> OutputElement { get; set; } = new();
