// -------------------------------------------------------------------------------------------------
// <copyright file="Actor.cs" company="Starion Group S.A.">
//
...
namespace uml4net.UseCases
{
    ...
    /// </summary>
    [Class(xmiId: "Actor", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class Actor : XmiElement, IActor
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IActor);
