// -------------------------------------------------------------------------------------------------
// <copyright file="AssociationClass.cs" company="Starion Group S.A.">
//
...
namespace uml4net.StructuredClassifiers
{
    ...
    public partial class AssociationClass : XmiElement, IAssociationClass
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IAssociationClass);
        ...
        public IContainerList<IProperty> OwnedEnd
        {
            get => this.ownedEnd ??= new ContainerList<IProperty>(this,
                containedElement => { containedElement.OwningAssociation = this; },
                containedElement => { if (ReferenceEquals(containedElement.OwningAssociation, this)) { containedElement.OwningAssociation = null; } });
