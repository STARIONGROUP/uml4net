// -------------------------------------------------------------------------------------------------
// <copyright file="ExpansionNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class ExpansionNode : XmiElement, IExpansionNode
    {
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExpansionNode);
        ...
        [Implements(implementation: "IExpansionNode.RegionAsInput")]
        ...
        [Implements(implementation: "IExpansionNode.RegionAsOutput")]
