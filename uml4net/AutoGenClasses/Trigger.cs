// -------------------------------------------------------------------------------------------------
// <copyright file="Trigger.cs" company="Starion Group S.A.">
//
...
namespace uml4net.CommonBehavior
{
    ...
    public partial class Trigger : XmiElement, ITrigger
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ITrigger);
        ...
        [Implements(implementation: "ITrigger.Event")]
        ...
        [Implements(implementation: "ITrigger.Port")]
        public List<IPort> Port { get; set; } = new();
