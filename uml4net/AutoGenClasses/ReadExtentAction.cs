// -------------------------------------------------------------------------------------------------
// <copyright file="ReadExtentAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// </summary>
    [Class(xmiId: "ReadExtentAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ReadExtentAction : XmiElement, IReadExtentAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadExtentAction);
        ...
        [Implements(implementation: "IReadExtentAction.Classifier")]
