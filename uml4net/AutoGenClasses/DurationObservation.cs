// -------------------------------------------------------------------------------------------------
// <copyright file="DurationObservation.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    public partial class DurationObservation : XmiElement, IDurationObservation
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDurationObservation);
        ...
        [Implements(implementation: "IDurationObservation.Event")]
        public List<INamedElement> Event { get; set; } = new();
        ...
        public List<bool> FirstEvent { get; set; } = new();
