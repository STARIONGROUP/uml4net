// -------------------------------------------------------------------------------------------------
// <copyright file="Deployment.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Deployments
{
    ...
    public partial class Deployment : XmiElement, IDeployment
    {
        /// <summary>
        ...
        /// </summary>
        private IContainerList<IDeploymentSpecification> configuration;
        ...
        [Implements(implementation: "IDeployment.DeployedArtifact")]
        public List<IDeployedArtifact> DeployedArtifact { get; set; } = new();
        ...
        [Implements(implementation: "IDeployment.Location")]
