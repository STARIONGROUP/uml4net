// -------------------------------------------------------------------------------------------------
// <copyright file="ReadVariableAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// </summary>
    [Class(xmiId: "ReadVariableAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ReadVariableAction : XmiElement, IReadVariableAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IReadVariableAction);
        ...
        /// </summary>
        [Property(xmiId: "ReadVariableAction-result", aggregation: AggregationKind.Composite, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Action-output")]
        [Implements(implementation: "IReadVariableAction.Result")]
        ...
        [Implements(implementation: "IVariableAction.Variable")]
