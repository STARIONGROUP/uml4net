...
namespace uml4net.POCO.Actions
{
    ...
    /// <summary>
    /// A SendSignalAction is an InvocationAction that creates a Signal instance and transmits it 
    /// to the target object. Values from the argument InputPins are used to provide values for the 
    /// attributes of the Signal. The requestor continues execution immediately after the Signal instance
    /// is sent out and cannot receive reply values.
    /// </summary>
    public class SendSignalAction : XmiElement, ISendSignalAction
    {
        /// <summary>
