// -------------------------------------------------------------------------------------------------
// <copyright file="JoinNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    public partial class JoinNode : XmiElement, IJoinNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IJoinNode);
        ...
        /// <summary>
        /// Backing field for <see cref="JoinSpec"/>
        /// </summary>
        private IContainerList<IValueSpecification> joinSpec;
