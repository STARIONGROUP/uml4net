// -------------------------------------------------------------------------------------------------
// <copyright file="IPrimitiveType.cs" company="Starion Group S.A.">
//
...
namespace uml4net.POCO.SimpleClassifiers
{
    ...
    /// <summary>
    /// A PrimitiveType defines a predefined DataType, without any substructure. A PrimitiveType may
    /// have an algebra and operations defined outside of UML, for example, mathematically.
    /// </summary>
    public class PrimitiveType : XmiElement, IPrimitiveType
    {
        /// <summary>
