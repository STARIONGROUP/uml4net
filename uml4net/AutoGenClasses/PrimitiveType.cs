// -------------------------------------------------------------------------------------------------
// <copyright file="PrimitiveType.cs" company="Starion Group S.A.">
//
...
namespace uml4net.SimpleClassifiers
{
    ...
    /// </summary>
    [Class(xmiId: "PrimitiveType", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class PrimitiveType : XmiElement, IPrimitiveType
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IPrimitiveType);
