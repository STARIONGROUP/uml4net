// -------------------------------------------------------------------------------------------------
// <copyright file="TimeExpression.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Values
{
    ...
    /// </summary>
    [Class(xmiId: "TimeExpression", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class TimeExpression : XmiElement, ITimeExpression
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(ITimeExpression);
        ...
        /// </summary>
        [Property(xmiId: "TimeExpression-expr", aggregation: AggregationKind.Composite, lowerValue: 0, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Element-ownedElement")]
        [Implements(implementation: "ITimeExpression.Expr")]
        public IContainerList<IValueSpecification> Expr
        {
            get => this.expr ??= new ContainerList<IValueSpecification>(this);
            set => this.expr = value;
        }

        /// <summary>
        /// Backing field for <see cref="Expr"/>
        /// </summary>
        private IContainerList<IValueSpecification> expr;
        ...
        /// </summary>
        [Property(xmiId: "TimeExpression-observation", aggregation: AggregationKind.None, lowerValue: 0, upperValue: int.MaxValue, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [Implements(implementation: "ITimeExpression.Observation")]
        public List<IObservation> Observation { get; set; } = new();
