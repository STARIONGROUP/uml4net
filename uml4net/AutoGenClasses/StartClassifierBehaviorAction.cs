// -------------------------------------------------------------------------------------------------
// <copyright file="StartClassifierBehaviorAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    public partial class StartClassifierBehaviorAction : XmiElement, IStartClassifierBehaviorAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IStartClassifierBehaviorAction);
