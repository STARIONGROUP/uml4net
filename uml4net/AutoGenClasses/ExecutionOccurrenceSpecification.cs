// -------------------------------------------------------------------------------------------------
// <copyright file="ExecutionOccurrenceSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    /// <summary>
    /// An ExecutionOccurrenceSpecification represents moments in time at which Actions or Behaviors start
    /// or finish.
    /// </summary>
    [Class(xmiId: "ExecutionOccurrenceSpecification", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class ExecutionOccurrenceSpecification : XmiElement, IExecutionOccurrenceSpecification
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IExecutionOccurrenceSpecification);
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IOccurrenceSpecification.Covered");
            set => throw new InvalidOperationException("Redefined by property IOccurrenceSpecification.Covered");
        }
        ...
        [Implements(implementation: "IExecutionOccurrenceSpecification.Execution")]
