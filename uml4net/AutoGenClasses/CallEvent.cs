// -------------------------------------------------------------------------------------------------
// <copyright file="CallEvent.cs" company="Starion Group S.A.">
//
...
namespace uml4net.CommonBehavior
{
    ...
    public partial class CallEvent : XmiElement, ICallEvent
    {
        /// <summary>
        ...
        /// </summary>
        [Property(xmiId: "CallEvent-operation", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: false, defaultValue: null)]
        [Implements(implementation: "ICallEvent.Operation")]
