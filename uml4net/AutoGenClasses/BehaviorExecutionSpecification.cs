// -------------------------------------------------------------------------------------------------
// <copyright file="BehaviorExecutionSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Interactions
{
    ...
    /// Behavior.
    /// </summary>
    [Class(xmiId: "BehaviorExecutionSpecification", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class BehaviorExecutionSpecification : XmiElement, IBehaviorExecutionSpecification
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IBehaviorExecutionSpecification);
        ...
        [Implements(implementation: "IBehaviorExecutionSpecification.Behavior")]
