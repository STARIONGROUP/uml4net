// -------------------------------------------------------------------------------------------------
// <copyright file="RaiseExceptionAction.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Actions
{
    ...
    /// <summary>
    /// A RaiseExceptionAction is an Action that causes an exception to occur. The input value becomes the
    /// exception object.
    /// </summary>
    [Class(xmiId: "RaiseExceptionAction", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class RaiseExceptionAction : XmiElement, IRaiseExceptionAction
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IRaiseExceptionAction);
        ...
        /// </summary>
        [Property(xmiId: "RaiseExceptionAction-exception", aggregation: AggregationKind.Composite, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        ...
        /// <summary>
        /// Backing field for <see cref="Exception"/>
        /// </summary>
        private IContainerList<IInputPin> exception;
