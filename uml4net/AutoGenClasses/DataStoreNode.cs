// -------------------------------------------------------------------------------------------------
// <copyright file="DataStoreNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    /// </summary>
    [Class(xmiId: "DataStoreNode", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("uml4net", "latest")]
    public partial class DataStoreNode : XmiElement, IDataStoreNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IDataStoreNode);
