// -------------------------------------------------------------------------------------------------
// <copyright file="DeploymentSpecification.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Deployments
{
    ...
    public partial class DeploymentSpecification : XmiElement, IDeploymentSpecification
    {
        /// <summary>
        ...
        [Implements(implementation: "IDeploymentSpecification.Deployment")]
        ...
        [Implements(implementation: "IDeploymentSpecification.DeploymentLocation")]
        ...
        [Implements(implementation: "IDeploymentSpecification.ExecutionLocation")]
        ...
        [Implements(implementation: "IArtifact.FileName")]
        ...
        [Implements(implementation: "IArtifact.Manifestation")]
        public IContainerList<IManifestation> Manifestation
        {
            get => this.manifestation ??= new ContainerList<IManifestation>(this);
            set => this.manifestation = value;
        }

        /// <summary>
        /// Backing field for <see cref="Manifestation"/>
        /// </summary>
        private IContainerList<IManifestation> manifestation;
        ...
        [Implements(implementation: "IArtifact.NestedArtifact")]
        public IContainerList<IArtifact> NestedArtifact
        {
            get => this.nestedArtifact ??= new ContainerList<IArtifact>(this);
            set => this.nestedArtifact = value;
        }

        /// <summary>
        /// Backing field for <see cref="NestedArtifact"/>
        /// </summary>
        private IContainerList<IArtifact> nestedArtifact;
        ...
        [SubsettedProperty(propertyName: "Namespace-ownedMember")]
        [Implements(implementation: "IArtifact.OwnedAttribute")]
        ...
        .Concat(this.Manifestation)
        .Concat(this.NameExpression)
        .Concat(this.NestedArtifact)
        ...
        [SubsettedProperty(propertyName: "Classifier-feature")]
        [SubsettedProperty(propertyName: "Namespace-ownedMember")]
        [Implements(implementation: "IArtifact.OwnedOperation")]
