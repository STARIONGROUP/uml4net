// -------------------------------------------------------------------------------------------------
// <copyright file="ActivityParameterNode.cs" company="Starion Group S.A.">
//
...
namespace uml4net.Activities
{
    ...
    public partial class ActivityParameterNode : XmiElement, IActivityParameterNode
    {
        /// <summary>
        ...
        /// </summary>
        public Type MetaclassInterface => typeof(IActivityParameterNode);
